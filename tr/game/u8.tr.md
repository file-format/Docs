...
U8 dosyaları, dosya boyutunu küçültmek için YAZ0 dosyası kullanılarak sıkıştırılan arşiv dosyalarıdır. [U8 dosya sistemi](http://wiki.tockdom.com/wiki/U8_(File_Format)) aşağıda gösterildiği gibi her düğümün 12 bayttan oluştuğu bir düğüm listesinden oluşur.
...
* [Mario Kit Wii U8 Dosya Biçimi](http://wiki.tockdom.com/wiki/U8_(File_Format))
