{
  ...
  "draft" : "false",
  "toc" : true,
  "title" :"DAP Dosyası - İndirme Hızlandırıcısı ve Devam Eden Dosyayı İndirme",
  "description":"DAP dosya formatı ve DAP dosyalarını oluşturabilen ve açabilen API'ler hakkında bilgi edinin.",
  "linktitle" : "DAP",
  "menu" : {
    "docs" : {
      "identifier":"misc-dap",
