{
  ...
  "description" :"E-kitap dosyaları, e-Okuyucu olarak bilinen dijital cihazlarda açılıp okunabilen elektronik dosyalardır. Yaygın e-kitap dosya uzantıları ve dosya formatları EPUB, FB2 ve Mobi'dir.",
  "title" :"E-Kitap dosyalarını açıp oluşturabilen E-Kitap Dosya Biçimleri ve API'ler hakkında bilgi edinin",
  "linktitle" : "E-Kitap Dosya Formatları",
  "menu" : {
    "docs" : {
      "parent" : "ebook",
      "weight" : "01"
...
Aşağıda, dosya uzantılarıyla birlikte yaygın E-Kitap dosya biçimlerinin bir listesi bulunmaktadır.
