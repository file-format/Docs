{
  ...
  "description" :"Sıkıştırılmış dosyalar, dosya boyutunu küçülterek depolayan dijital arşivlerdir. Popüler sıkıştırılmış dosya biçimleri arasında ZIP, 7Z, BZ2, GZ, RAR ve TAR bulunur.",
  "title" :"Arşiv dosyalarını açıp oluşturabilen Sıkıştırma Dosyası Biçimleri ve API'ler hakkında bilgi edinin",
  "linktitle" : "Sıkıştırma Dosya Formatları",
  "menu" : {
    "docs" : {
      "parent" : "compression",
      "weight" : "01"
...
Aşağıda, dosya uzantılarıyla birlikte yaygın sıkıştırma dosyası biçimlerinin bir listesi bulunmaktadır.
