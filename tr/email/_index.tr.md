{
  ...
  "description" :"E-posta dosyaları, metin, ekler, gönderen ve alıcıların bilgilerini içeren dijital kaplardır. Yaygın e-posta dosyası biçimleri arasında EML, MSG, EMLX, TNEF, ICS, OFT, PST ve OST bulunur.",
  "title" :"E-posta Dosya Biçimleri ve E-posta dosyalarını açıp oluşturabilen API'ler hakkında bilgi edinin",
  "linktitle" : "E-posta Dosya Biçimleri",
  "menu" : {
    "docs" : {
      "parent" : "email",
      "weight" : "01"
...
Aşağıda, ilişkili uzantılarıyla birlikte popüler e-posta dosyası türlerinin bir listesi bulunmaktadır.
