{
  ...
  "description":"Video dosyaları, dijital video verilerini bir bilgisayar sisteminde depolar ve gerçekte bir dizi görüntüdür. AVI, M4V, MOV ve WMV gibi yaygın video dosyası formatlarını açmayı öğrenin.",
  "title" :"Video dosyalarını açmak ve oluşturmak için Video Dosyası Biçimleri ve API'ler hakkında bilgi edinin",
  "linktitle" : "Video Dosya Formatları",
  "menu" : {
    "docs" : {
      "parent" : "video",
      "weight" : "01"
...
Aşağıda, videolarla ilgili hemen hemen tüm günlük işlerde kullanımlarını bulan popüler Video dosyası biçimlerinin bir listesi bulunmaktadır.
