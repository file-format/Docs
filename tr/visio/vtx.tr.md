{
  "date" : "2019-10-11",
  "keywords" :[ "vtx dosyası", "vtx dosya biçimi", "vtx dosyası nedir", "dosya", "vtx örneği", "vtx dosya uzantısı","uzantı", "biçim"],
  "author" : {
    "display_name" : "Kashif Iqbal"
},
  "draft" : "false",
  "toc" : true,
  "title" :"VTX - Microsoft Visio Çizim Şablonu Dosya Biçimi",
  "description":"VTX dosya formatı ve VTX dosyalarını oluşturabilen ve açabilen API'ler hakkında bilgi edinin.",
  "linktitle" : "VTX",
  "menu" : {
    "docs" : {
