{
  "date" : "2019-10-11",
  "keywords" :[ "vsx dosyası", "vsx dosya biçimi", "vsx dosyası nedir", "dosya", "vsx örneği", "vsx dosya uzantısı","uzantı", "biçim" ],
  "author" : {
    "display_name" : "Kashif Iqbal"
},
  "draft" : "false",
  "toc" : true,
  "title" :"VSX - Microsoft Visio Şablon Dosya Biçimi",
  "description":"VSX dosya formatı ve VSX dosyalarını oluşturabilen ve açabilen API'ler hakkında bilgi edinin.",
  "linktitle" : "VSX",
  "menu" : {
    "docs" : {
...
XML düzenleyicide açılan örnek bir VSX dosyası aşağıda gösterildiği gibidir. Tipik bir VSX dosyası, XML temsilinden gözlemlendiği gibi aşağıdaki düğümlere sahiptir.

### Döküman özellikleri ###

Belge Özellikleri bölümünde yer alan bazı öğeler şunlardır:
...
Tipik bir belge ayarları düğümü aşağıdaki öğeleri içerir.
...
Renkler düğümü, belge boyunca kullanılacak renk girişlerini içerir.
...
Dosyadaki FaceNames düğümü, belgede kullanılan TypeFace.FaceNames özelliklerini temsil eder.
...
StyleSheets düğümü, belgede kullanılan stil sayfaları hakkında bilgi içerir. Her stil sayfası, stil özellikleri, çizgiler, dolgu desenleri, metin blokları ve benzeri diğer öğeler hakkında bilgi içerebilir.

### Belge Sayfası ###

DocumentSheet düğümü, belge özellikleri ve Kullanıcı adı bilgileri hakkında bilgi içerir ve aşağıdaki gibi görünür:
...
Sayfa Özellikleri, Düzenler, Cetvel Izgaraları, Şekiller, Görüntüler ve diğer benzer veriler gibi bir Visio belgesinin sayfaları hakkında bilgiler içerir.
