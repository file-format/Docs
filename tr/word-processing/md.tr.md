...
O zamandan beri Markdown, [CPAN](https://en.wikipedia.org/) üzerinde bulunan bir Perl [modülünde](https://en.wikipedia.org/wiki/Modular_programming) olduğu gibi başkaları tarafından da yeniden uygulandı. wiki/CPAN) ve diğer çeşitli programlama dillerinde. [BSD tarzı bir lisans](https://en.wikipedia.org/wiki/BSD_license) altında dağıtılır ve birkaç [içerik yönetim sistemi](https://en.wikipedia.org/wiki/BSD_license) ile birlikte gelir veya bunlar için bir eklenti olarak kullanılabilir. en.wikipedia.org/wiki/Content_management_system).
