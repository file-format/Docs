{
  ...
  "draft" : "false",
  "toc" : true,
  "title" :"ASC Dosyası - Adobe ActionScript Dosya Biçimi",
...
ASC dosyaları, [Adobe Media Encoder](https://www.adobe.com/products/media-encoder.html) ile açılıp düzenlenebilen metin dosyaları olarak kaydedilir. Bunlar metin dosyaları olarak oluşturulur ve kaydedilir ve Microsoft Notepad, Notepad++ ve Apple TextEdit gibi herhangi bir metin düzenleyiciyle açılabilir. ASC dosyası, Flash Media Server çalıştığında ve uygulama çalıştırıldığında varsayılan olarak yürütülür.
