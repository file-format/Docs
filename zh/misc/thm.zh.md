...
Sony Themes Creator 软件可用于为索尼爱立信手机生成新主题。用户可以按照索尼【Themes Creator 开发者指南】（https://developer.sony.com/develop/theme-creator/get-started）来创建主题。

## 参考

* [Sony Themes Creator 开发者指南](https://developer.sony.com/develop/theme-creator/get-started)
