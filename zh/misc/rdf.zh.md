...
例如，RDF 三元组可以表示“John Smith 年龄为 30”，如下所示：
...
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
   ...
   <foaf:人 rdf:about="#john">
     <foaf:name>约翰·史密斯</foaf:name>
     <foaf:年龄>30</foaf:年龄>
   </foaf：人>
</rdf：RDF>
````
...
选择看起来最简单或最适合您想要处理 RDF 文件的方法。 如果您只想查看里面的内容，文本编辑器可能就足够了。 如果您想做更复杂的事情，请根据您的舒适程度和要求考虑其他选项之一。

＃＃ 参考
* [资源描述框架](https://en.wikipedia.org/wiki/Resource_Description_Framework)