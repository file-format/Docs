{
  ...
  "description":"了解 PZZ 格式以及可创建和打开 PZZ 文件的 API。" ,
  "linktitle" : "CJS",
  "menu" : {
    "docs" : {
      "parent" : "compression",
      "identifier":"compression-zh-pzz"
}
} ,
  "lastmod" : "2023-10-29"
}
...
Poser 生成的 PZZ 文件是一种压缩文件格式，其尺寸较小，适合通过互联网和其他媒体传输。 Poser 还以未压缩的形式保存场景文件，扩展名为 **.PZ3**，如果需要，您可以将其压缩为 **ZIP** 或 **RAR** 实现。 Bondware 于 2019 年 6 月从 Smith Micro 收购了 Poser。
