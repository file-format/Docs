...
由 Microsoft 引入和记录的富文本格式 (**RTF**) 代表了一种对格式化文本和图形进行编码以供在应用程序中使用的方法。该格式有利于与其他 Microsoft 产品的跨平台文档交换，从而达到互操作性的目的。此功能使其成为文字处理软件之间数据传输的标准，因此可以将内容从一个操作系统传输到另一个操作系统，而不会丢失文档格式。文件格式规范由微软公开[下载](https://www.microsoft.com/en-us/download/details.aspx?id#10725)，可以从开发者的角度参考。
...
由 Microsoft 引入和记录的富文本格式 (**RTF**) 代表了一种对格式化文本和图形进行编码以供在应用程序中使用的方法。该格式有利于与其他 Microsoft 产品的跨平台文档交换，从而达到互操作性的目的。此功能使其成为文字处理软件之间数据传输的标准，因此，内容可以从一个操作系统传输到另一个操作系统，而不会丢失文档格式。文件格式规范由微软公开[下载](https://www.microsoft.com/en-us/download/details.aspx?id#10725)，可以从开发者的角度参考。
...
* [RTF 1.9.1 规范](https://www.microsoft.com/en-us/download/details.aspx?id#10725)
