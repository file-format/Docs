{
  ...
  "draft" : "false",
  "categories" :[ "alapok" ],
  "description" :"A tömörített fájlok digitális archívumok, amelyek a fájlméret csökkentésével tárolják a fájlokat. A népszerű tömörített fájlformátumok közé tartozik a ZIP, 7Z, BZ2, GZ, RAR és TAR.",
  "title" :"További információ a tömörítési fájlformátumokról és az archív fájlok megnyitására és létrehozására alkalmas API-król",
  "linktitle" : "Tömörítési fájlformátumok",
  "menu" : {
    "docs" : {
      "parent" : "compression",
      "weight" : "01"
...
Az alábbiakban felsoroljuk a gyakori tömörítési fájlformátumokat a fájlkiterjesztésekkel együtt.
