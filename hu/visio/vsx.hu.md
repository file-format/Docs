{
  "date" : "2019-10-11",
  "keywords" :[ "vsx fájl", "vsx fájlformátum", "mi az a vsx fájl", "fájl", "vsx példa", "vsx fájl kiterjesztése", "kiterjesztés", "formátum" ],
  "author" : {
  ...
  "description":"További információ a VSX fájlformátumról és az API-król, amelyek VSX fájlokat hozhatnak létre és nyithatnak meg.",
  "linktitle" : "VSX",
  "menu" : {
    "docs" : {
...
Az XML-szerkesztőben megnyitott minta VSX-fájl az alábbiak szerint látható. Egy tipikus VSX-fájl a következő csomópontokkal rendelkezik, amint az XML-ábrázolása alapján megfigyelhető.

### Dokumentum tulajdonságai ###

A Dokumentum tulajdonságai részben található néhány elem a következő:
...
Egy tipikus dokumentumbeállítási csomópont a következő elemeket tartalmazza.
...
A színcsomópont színbejegyzéseket tartalmaz, amelyeket a dokumentumban végig kell használni.
...
A fájl FaceNames csomópontja a dokumentumban használt TypeFace.FaceNames tulajdonságokat képviseli.
...
A StyleSheets csomópont információkat tartalmaz a dokumentumban használt stíluslapokról. Minden stíluslap tartalmazhat információkat a stílustulajdonságokról, vonalakról, kitöltési mintákról, szövegblokkokról és más hasonló elemekről.

### Dokumentumlap ###

A DocumentSheet csomópont információkat tartalmaz a dokumentum tulajdonságairól és a felhasználói név információiról, és a következőképpen néz ki:
...
Információkat tartalmaz a Visio-dokumentum oldalairól, például oldaltulajdonságokról, elrendezésekről, vonalzórácsokról, alakzatokról, képekről és más hasonló adatokról.
