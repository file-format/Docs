{
  "date" : "2019-10-11",
  "keywords" :[ "pptm fájl", "pptm fájlformátum", "mi az a pptm fájl", "fájl", "pptm példa", "pptm fájl kiterjesztése", "kiterjesztés", "formátum" ],
  "author" : {
    "display_name" : "Kashif Iqbal"
},
  "draft" : "false",
  "toc" : true,
  "title" :"PPTM – makró-engedélyezett PowerPoint-bemutató fájlformátum",
  "description":"További információ a PPTM fájlformátumról és az API-król, amelyek PPTM-fájlokat hozhatnak létre és nyithatnak meg.",
  "linktitle" : "PPTM",
  "menu" : {
    "docs" : {
      "parent" : "presentation"
