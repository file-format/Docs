{
  ...
  "draft" : "false",
  "toc" : true,
  "title" :"AS3PROJ - FlashDevelop ActionScript 3 projektfájl formátum",
  "description":"További információ az AS3PROJ fájlformátumról és az API-król, amelyek AS3PROJ fájlokat hozhatnak létre és nyithatnak meg.",
  "linktitle" : "AS3PROJ",
  "menu" : {
    "docs" : {
      "parent" : "programming"
...
Az AS3PROJ fájl [XML](/hu/web/xml/) fájlformátumban kerül mentésre, amely az információcsere univerzális fájlformátuma. Bármilyen szövegszerkesztőben megnyitható, például a Notepad, Notepad++ és Atom segítségével, hogy megvizsgálja a tartalmat.
