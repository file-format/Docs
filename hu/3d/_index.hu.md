{
  "date" : "2020-01-17",
  "keywords" :[ "3D", "fájl", "formátum", "kiterjesztés", "GLB" ],
  "author" : {
    "display_name" : "Kashif Iqbal"
},
  "draft" : "false",
  "description" :"A 3D fájlok a háromdimenziós objektumok digitális ábrázolása. Ismerje meg a 3D fájlformátumok megnyitását, beleértve a GLB, FBX, GLTF, OBJ, PLY, JT, 3DS és más formátumokat.",
  "categories" :[ "alapok" ],
  "title" :"További információ a 3D fájlformátumokról és API-król, amelyek képesek megnyitni és létrehozni 3D fájlokat",
  "linktitle" : "3D fájlformátumok",
  "menu" : {
    "docs" : {
      "parent" : "3d",
      "weight" : "01"
...
Az alábbiakban felsoroljuk azokat a népszerű 3D fájlformátumokat, amelyek szinte minden 3D-vel kapcsolatos napi munkában használhatók.
