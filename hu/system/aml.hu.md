...
Az AML-fájlok bináris fájlokként kerülnek mentésre bájtkóddal írt tartalommal rendelkező lemezre. Az ACPI szabvány fájlformátum-specifikációi elérhetők az [uefi](https://uefi.org/) webhelyen. A nyelvet úgy tervezték, hogy stabilitást és visszamenőleges kompatibilitást kínáljon, kevesebb újraírást vagy újraépítést igényelve az alkalmazásveremben.
