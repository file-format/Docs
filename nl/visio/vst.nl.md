{
  "date" : "2019-10-11",
  "keywords" :[ "vst-bestand", "vst-bestandsindeling", "wat is een vst-bestand", "bestand", "vst-voorbeeld", "vst-bestandsextensie","extensie", "formaat"],
  "author" : {
  ...
  "toc" : true,
  "title" :"VST",
  "description":"Meer informatie over VST-bestandsindeling en API's die VST-bestanden kunnen maken en openen.",
  "linktitle" : "VST",
  "menu" : {
    "docs" : {
