{
  "date" : "2019-10-11",
  "keywords" :[ "vssm-bestand", "vssm-bestandsformaat", "wat is een vssm-bestand", "bestand", "vssm-voorbeeld", "vssm-bestandsextensie","extensie", "formaat"],
  "author" : {
    "display_name" : "Kashif Iqbal"
},
  "draft" : "false",
  "toc" : true,
  "title" :"VSSM - Microsoft Visio Macro-enabled bestandsformaat",
  "description":"Meer informatie over de VSSM-bestandsindeling en API's die VSSM-bestanden kunnen maken en openen.",
  "linktitle" : "VSSM",
  "menu" : {
    "docs" : {
...
Het VSSM-bestandsformaat is geïntroduceerd met Microsoft Visio 2013 dat is gebaseerd op de OpenOffice XML-specificaties. Bepaalde andere bestandstypen die deel uitmaken van de Visio 2013-bestandsindeling zijn onder meer:
