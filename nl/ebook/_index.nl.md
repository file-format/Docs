{
  ...
  "description" :"Ebook-bestanden zijn elektronische bestanden die kunnen worden geopend en gelezen op digitale apparaten die bekend staan als eReaders. Veelgebruikte bestandsextensies voor e-boeken en hun bestandsindelingen zijn EPUB, FB2 en Mobi.",
  "title" :"Meer informatie over EBook-bestandsindelingen en API's die eBook-bestanden kunnen openen en maken",
  "linktitle" : "EBook-bestandsindelingen",
  "menu" : {
    "docs" : {
      "parent" : "ebook",
      "weight" : "01"
...
Hieronder volgt een lijst met veelvoorkomende EBook-bestandsindelingen samen met hun bestandsextensies.
