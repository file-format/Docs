{
  ...
  "draft" : "false",
  "toc" : true,
  "title" :"DER-bestand - DER-certificaatbestandsformaat",
  "description":"Meer informatie over DER-bestandsindelingen en API's die DER-bestanden kunnen maken en openen.",
  "linktitle" : "DER",
  "menu" : {
    "docs" : {
      "identifier":"web-der",
...
DER-bestanden worden op schijf opgeslagen in binaire bestandsindeling die niet door mensen leesbaar is. Deze certificaatbestanden worden geladen en herkend door standaard webbrowsers voor veilige navigatie.

### Hoe ziet een DER-gecodeerd certificaat eruit?

Hieronder ziet u een voorbeeld van een DER-gecodeerd SSL/TLS-certificaat.
...
## Converteer DER-gecodeerd certificaat naar PEM

Een DER-gecodeerd certificaatbestand kan worden geconverteerd naar PEM met behulp van de volgende opdracht.
...
* [Verkrijg een digitaal certificaat en maak een digitale handtekening
](https://support.microsoft.com/en-us/office/verkrijg-een-digitaal-certificaat-en-maak-een-digitale-handtekening-e3d9d813-3305-4164-a820-2e063d86e512)
