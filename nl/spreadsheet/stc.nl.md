{
  "date" : "2021-02-26",
  "keywords" :[ "stc", "bestand", "extensie", "bestandsindeling", "StarOffice Calc", "Spreadsheet"],
  "author" : {
  ...
  "title" :"STC - StarOffice Calc Spreadsheet-sjabloonbestandsindeling",
  "linktitle" : "STC",
  "menu" : {
    "docs" : {
...
STC-bestanden worden op schijf opgeslagen in binaire bestandsindeling. De specificaties van de interne bestandsindeling van STC-bestanden zijn niet openbaar beschikbaar ter referentie van de ontwikkelaar.

## Referenties ##

* [StarOffice - Door Wikipedia](https://en.wikipedia.org/wiki/StarOffice)
