{
  "date" : "2020-01-17",
  "keywords" :[ "3D", "bestand", "formaat", "extensie", "GLB" ],
  "author" : {
    "display_name" : "Kashif Iqbal"
},
  "draft" : "false",
  "description" :"3D-bestanden zijn een digitale weergave van driedimensionale objecten. Leer 3D-bestandsindelingen te openen, waaronder GLB, FBX, GLTF, OBJ, PLY, JT, 3DS en andere.",
  "categories" :[ "grondbeginselen" ],
  "title" :"Meer informatie over 3D-bestandsindelingen en API's die 3D-bestanden kunnen openen en maken",
  "linktitle" : "3D-bestandsindelingen",
  "menu" : {
    "docs" : {
      "parent" : "3d",
      "weight" : "01"
...
Hieronder volgt een lijst met populaire 3D-bestandsindelingen die in bijna al het dagelijkse werk met betrekking tot 3D worden gebruikt.
