...
Een eenvoudig XSD-bestand met een inkooporderschema definieert de elementen met behulp van tags zoals weergegeven in het volgende [XSD-voorbeeld door Microsoft](https://docs.microsoft.com/en-us/visualstudio/xml-tools/sample-xsd-file -simple-schema?view=vs-2022).
...
- [XSD-voorbeeldvoorbeeld](https://docs.microsoft.com/en-us/visualstudio/xml-tools/sample-xsd-file-simple-schema?view=vs-2022)
