{
  "date" : "2019-10-11",
  "keywords" :[ "cdr-bestand", "cdr-bestandsformaat", "wat is een cdr-bestand", "bestand", "cdr-voorbeeld", "cdr-bestandsextensie","extensie", "formaat"],
  "author" : {
    "display_name" : "Kashif Iqbal"
},
  "draft" : "false",
  "toc" : true,
  "title" :"CDR-bestandsindeling - afbeeldingsbestand voor vectortekeningen",
  "description":"Meer informatie over CDR-bestandsindeling en API's die CDR-bestanden kunnen maken en openen.",
  "linktitle" : "CDR",
  "menu" : {
    "docs" : {
      "parent" : "image"
...
CDR, een eigen formaat van Corel, heeft geen publiekelijk beschikbare technische specificaties. Het formaat is na de eerste lancering in 1989 voortdurend in ontwikkeling geweest en ondersteunt basisfuncties zoals tekst, kleurbeheer en steunkleuren.
