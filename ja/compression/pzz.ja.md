...
Poser によって生成される PZZ ファイルは、インターネットやその他のメディア上で転送できるようにサイズが小さい圧縮ファイル形式です。 また、Poser はシーン ファイルを **.PZ3 拡張子**を持つ非圧縮形式で保存します。これは、必要に応じて **ZIP** または **RAR** に圧縮することができます。 Bondware は、2019 年 6 月に Smith Micro から Poser を買収しました。
