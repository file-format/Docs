...
DVDに傷が付くと、IFOファイルが破損する可能性があります。そのため、IFO ファイルのバックアップとして BUP ファイルが作成されます。 IFO ファイルを読み取れない場合は、代わりに BUP ファイルが読み取られます。これらのファイルは、ディスク上のコンテンツのインデックスを含む [VOB](https://docs.fileformat.com/video/vob/) ファイルと同じ場所にあります。
