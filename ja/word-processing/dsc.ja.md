...
DSC ファイルが作成され、プレーン テキスト ファイルとしてディスクに保存されます。これらは、Microsoft メモ帳などの互換性のあるテキスト エディタで開いて編集できます。 DSC は、[.txt](/word-processing/dsc/) ファイルと同様のプレーン テキスト形式に従い、ソフトウェアの機能または指示に従ってソフトウェアの詳細を入力できます。
