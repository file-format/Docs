...
パッケージは、[ZIP](/compression/zip/) アーカイブであり、複数の部分を含み、[ISO/IEC-29500-2](https://go.microsoft.com/fwlink/ ?LinkId=150883)。 ACCDT ファイルには、関係のターゲットとなるテンプレート メタデータ パーツが少なくとも 1 つ含まれている必要があります。このテンプレート メタデータは、ACCDT ファイルの開始部分です。
