{
  "date" : "2021-09-06",
  "keywords" :["aq", "rozszerzenie", "plik", "format pliku", "Typ pliku bazy danych", "Format pliku bazy danych", "Plik bazy danych Ancestral Quest" ],
  "author" : {
    "display_name" : "Kashif Iqbal"
},
  "draft" : "false",
  "toc" : true,
  "description" :"Poznaj format pliku AQ i interfejsy API, które mogą tworzyć i otwierać pliki AQ.",
  "title" :"AQ - Plik Bazy Danych Poszukiwań Przodków",
  "linktitle" : "AQ",
  "menu" : {
    "docs" : {
      "parent" : "database"
...
Pliki AQ są zapisywane jako pliki binarne, a ich wewnętrzny format pliku nie jest dostępny.
