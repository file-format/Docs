...
Ponieważ Gnumeric obsługuje kilka różnych formatów plików, może konwertować natywne pliki GNM do formatu [CSV](/pl/spreadsheet/csv/), [XLSX](/pl/spreadsheet/xlsx/), Microsoft Works (.wks), [HTML](/pl/ web/html/), [LaTex](/pl/przetwarzanie tekstu/latex/) i [Lotus 1-2-3](/pl/spreadsheet/123/).
