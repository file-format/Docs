...
Oto krótki przegląd komponentów trójki RDF:
...
3.  **Potrójne magazyny i bazy danych:** Jeśli Twój plik RDF jest naprawdę duży lub chcesz z nim zrobić bardziej zaawansowane rzeczy, możesz użyć czegoś, co nazywa się potrójnym magazynem. Pomyśl o tym jak o inteligentnej bazie danych zawierającej dane RDF. Programy takie jak Apache Jena, Virtuoso lub Stardog mogą pomóc w przechowywaniu i zarządzaniu dużymi ilościami informacji RDF.
