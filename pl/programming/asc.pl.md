{
  ...
  "draft" : "false",
  "toc" : true,
  "title" :"Plik ASC - format pliku Adobe ActionScript",
...
Pliki ASC są zapisywane jako pliki tekstowe, które można otwierać i edytować za pomocą [Adobe Media Encoder](https://www.adobe.com/products/media-encoder.html). Są one tworzone i zapisywane jako pliki tekstowe i można je otwierać za pomocą dowolnego edytora tekstu, takiego jak Microsoft Notepad, Notepad++ i Apple TextEdit. Plik ASC jest domyślnie wykonywany, gdy uruchomiony jest program Flash Media Server i aplikacja.
