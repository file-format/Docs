{
  ...
  "draft" : "false",
  "toc" : true,
  "title" :"Plik DER - Format pliku certyfikatu DER",
  "description":"Dowiedz się o formacie pliku DER i interfejsach API, które mogą tworzyć i otwierać pliki DER.",
  "linktitle" : "DER",
  "menu" : {
    "docs" : {
      "identifier":"web-der",
...
Pliki DER są zapisywane na dysku w formacie pliku binarnego, który nie jest czytelny dla człowieka. Te pliki certyfikatów są ładowane i rozpoznawane przez standardowe przeglądarki internetowe w celu zapewnienia bezpiecznej nawigacji.

### Jak wygląda certyfikat zakodowany w DER?

Przykład certyfikatu SSL/TLS z kodowaniem DER pokazano poniżej.
...
## Konwertuj certyfikat zakodowany w formacie DER na PEM

Plik certyfikatu zakodowany w formacie DER można przekonwertować na format PEM za pomocą następującego polecenia.
...
* [Uzyskaj certyfikat cyfrowy i utwórz podpis cyfrowy
