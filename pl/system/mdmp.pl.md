...
* [Jak odczytać mały plik zrzutu pamięci tworzony przez system Windows w przypadku awarii](https://docs.microsoft.com/en-us/troubleshoot/windows-client/performance/read-small-memory-dump -plik)
