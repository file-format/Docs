{
  ...
  "keywords": [
"fochomhad",
"cad is fochomhad ann",
"sampla de chomhad fotheideal MicroDVD",
"Eisínteachtaí Fotheideal",
"Oscail Fo",
"Cineálacha Comhaid Fotheideal",
"conas fo-chomhad a oscailt",
"comhad",
"SUB síneadh comhad",
"síneadh"
],
  ...
  "draft": "false",
  "toc": true,
  "title": "Formáid Fotheideal Fotheideal - MicroDVD",
  "description": "Faigh amach faoi fhormáid SUB agus APIanna ar féidir leo fochomhaid a chruthú agus a oscailt.",
  "linktitle": "SUB",
  "menu": {
    "docs": {
      "identifier": "video-sub-ga",
      "parent": "video"
}
},
  "lastmod": "2023-06-21"
...
Is éard atá i bhfochomhad ná formáid comhaid fotheideal MicroDVD a úsáidtear chun fotheidil a thaispeáint i bhfíseáin, go hiondúil tá iarmhír .fo-chomhad acu. Tá faisnéis uainiúcháin agus téacs do gach iontráil fotheideal sna comhaid seo.

Úsáideann comhaid fotheideal MicroDVD formáid shimplí bunaithe ar théacs ina bhfuil roinnt línte i ngach iontráil fotheideal. Sa chéad líne tá faisnéis uainiúcháin an fhotheidil, lena n-áirítear na stampaí ama tosaigh agus deiridh. Tá téacs fotheideal iarbhír sna línte ina dhiaidh sin.
...
## Cad is brí le Open Sub?

Is gnách go gciallaíonn Open Sub OpenSubtitles ar ardán móréilimh é a sholáthraíonn fotheidil do scannáin agus seónna teilifíse i dteangacha éagsúla. Cuireann sé bailiúchán mór de chomhaid fotheideal ar fáil a chuireann a phobal úsáideoirí leis. Is féidir leat cuairt a thabhairt ar shuíomh Gréasáin OpenSubtitles (www.opensubtitles.org) chun fotheidil a chuardach agus a íoslódáil do na scannáin nó na sraitheanna teilifíse atá uait.
...
Is féidir leis na seinnteoirí meán seo a leanas SUB comhad a oscailt mar rian fotheidil.

- Imreoir meáin VideoLAN VLC
- MPlayer

Chun Fo-chomhad a oscailt i seinnteoir VLC lean na céimeanna seo

- Oscail seinnteoir VLC agus seinn do fhíseán
- Ó bharra roghchláir VLC Media Player, roghnaigh **Fotheidil > Cuir Comhad Fotheideal leis ....**
- Déan nascleanúint chuig SUB File agus oscail é
