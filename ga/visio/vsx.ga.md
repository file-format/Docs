{
  ...
  "draft" : "false",
  "toc" : true,
  "title" : "VSX - Formáid Comhaid Stionsal Microsoft Visio",
  "description":"Foghlaim faoi fhormáid comhaid VSX agus APIs ar féidir leo comhaid VSX a chruthú agus a oscailt.",
  "linktitle" : "VSX",
  "menu" : {
    "docs" : {
	  "identifier":"visio-vsx-ga",
      "parent" : "visio"
}
},
  "lastmod" : "2020-08-03"
...
## Cad is comhad VSX ann?

Files with .vsx extension refer to stencils that consist of drawings and shapes that are used for creating diagrams in Microsoft Visio. VSX files are saved in XML file format and was supported till Visio 2013. Tá siad seo difriúil leis an mbunfhormáid comhaid [VSDX](/visio/vsdx/) a tugadh isteach le Microsoft Visio 2013. Is féidir comhaid VSX a oscailt in aon eagarthóir téacs chun an t-ábhar a fheiceáil. Is féidir comhaid VSX a thiontú go roinnt formáidí comhaid éagsúla cosúil le PDF agus HTML.

## Formáid Chomhaid VSX ##

Tá comhad VSX samplach a osclaíodh in eagarthóir XML mar a thaispeántar thíos. Tá na nóid seo a leanas ag gnáthchomhad VSX mar a breathnaíodh óna léiriú XML.

### Airíonna an Doiciméid ###

Seo a leanas roinnt de na heilimintí atá sa rannán Airíonna an Doiciméid:
...
Tá na heilimintí seo a leanas i ngnáthnód socruithe doiciméad.
...
Tá iontrálacha datha sa nód dathanna le húsáid tríd an doiciméad.
...
### Ainmneacha Aghaidheanna ###

Seasann an nód FaceNames sa chomhad airíonna TypeFace.FaceNames a úsáidtear sa doiciméad.
...
Tá faisnéis sa nód StyleSheets faoi na stílbhileoga a úsáidtear sa doiciméad. Is féidir faisnéis a bheith ag gach stílbhileog faoi airíonna stíle, faoi línte, faoi phatrúin líonta, faoi bhloic téacs agus faoi eilimintí eile dá leithéid.

### Bileog Doiciméid ###

Tá faisnéis sa nód DocumentSheet faoi airíonna an doiciméid agus faisnéis faoin ainm Úsáideora, agus féach mar a leanas:
...
Tá faisnéis ann faoi na leathanaigh ar dhoiciméad Visio mar Airíonna Leathanach, Leagan Amach, Eangacha Rialtóra, Cruthanna, Íomhánna agus sonraí eile dá samhail.
