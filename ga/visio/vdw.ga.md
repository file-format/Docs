{
  ...
  "draft" : "false",
  "toc" : true,
  "title" : "VDW - Formáid Chomhaid Seirbhís Grafaicí Visio",
  "description":"Foghlaim faoi fhormáid comhaid VDW agus APIs ar féidir leo comhaid VDW a chruthú agus a oscailt.",
  "linktitle" : "VDW",
  "menu" : {
    "docs" : {
      "identifier":"visio-vdw-ga",
      "parent" : "visio"
}
},
  "lastmod" : "2019-09-10"
}
## Cad is comhad VDW ann?

Is é VDW formáid comhaid Visio Graphics Service a shonraíonn na sruthanna agus na stórais a theastaíonn chun líníocht Gréasáin a dhéanamh. Is éard is líníocht ghréasáin ann ná bailiúchán de leathanaigh líníochta, de chruthanna, de chlónna, d'íomhánna, de naisc sonraí, agus de fhaisnéis nuashonraithe léaráidí is féidir a dhéanamh mar líníocht veicteora nó raster. Is féidir comhaid VDW a oscailt i Microsoft Visio freisin ach déantar iad a shábháil go príomha le húsáid ar an ngréasán. Cuireann Microsoft Visio an cumas comhaid Visio a thiontú go formáidí éagsúla comhaid lena n-áirítear [PNG](/image/png/), [BMP](/image/bmp/), [PDF](/pdf/) agus cinn eile.

## **VDW** Formáid Chomhaid
