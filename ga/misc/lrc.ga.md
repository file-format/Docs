{
  ...
  "draft": "false",
  "toc": true,
  "title": "Formáid Chomhaid an LRC - Cad is comhad LRC ann?",
  "description": "Foghlaim faoi chomhad Lyric an LRC agus APIanna ar féidir leo comhaid LRC a chruthú agus a oscailt.",
  "linktitle": "LRC",
  "menu": {
    "docs": {
      "parent": "misc",
      "identifier": "misc-lr-gac"
}
},
  "lastmod": "2022-01-26"
}
...
Tá na Clibeanna Am Líne san fhormáid `[mm:ss.xx]` áit a bhfuil mm mar nóiméid, ss soicind agus xx arb ionann é agus céaduithe soicind.
...
Leagan leathnaithe d'fhormáid shimplí an LRC is ea formáid fheabhsaithe an LRC. Cuireann sé Clib Am Focal san fhormáid `<mm:ss.xx> ` ag deireadh an fhocail roimhe.
