{
  ...
  "draft": "false",
  "toc": true,
  "title": "MSO - Comhad Macra Tagartha Microsoft Office",
  "description": "Foghlaim faoi chomhad MSO agus APIanna ar féidir leo comhaid MSO a chruthú agus a oscailt.",
  "linktitle": "MSO",
  "menu": {
    "docs": {
      "parent": "misc",
      "identifier": "misc-ms-gao"
}
},
  "lastmod": "2022-03-12"
}

## Cad is comhad MSO ann?
...
## Formáid Comhaid Microsoft MSO

Déantar comhaid MSO a shábháil i bhFormáid Chomhaid Doiciméid Chomhdhlúite Microsoft (MCDF) ar a dtugtar freisin an fhormáid comhaid dhénártha stórála le cur chun feidhme cumaisc stórála struchtúrtha Comhaid Nascála agus Leabú Oibiachta (OLE) nó Múnla Comhpháirte Oibiachta (COM).

### Struchtúr Formáide Comhad MSO
