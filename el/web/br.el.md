...
Ένα αρχείο BR είναι ένα συμπιεσμένο αρχείο Ιστού που δημιουργείται με την εφαρμογή του αλγόριθμου συμπίεσης δεδομένων ανοιχτού κώδικα, **Brotli**. Χρησιμοποιείται για την αποθήκευση στοιχείων ιστοσελίδων όπως φύλλα στυλ ([CSS](/el/web/css/)), εικόνες ([SVG](/el/image/svg/)), [XML](/el/web/xml/) και δέσμες ενεργειών αρχεία ([JS](/el/web/js/)). Οι σύγχρονοι ιστότοποι, όπως ο Chrome και ο Firefox, χρησιμοποιούν αρχεία BR για να μειώσουν τον χρόνο φόρτωσης της σελίδας, με αποτέλεσμα καλύτερη εμπειρία χρήστη.
