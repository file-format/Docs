...
Ένα αρχείο με επέκταση .dbm (Γλώσσα σήμανσης βάσης δεδομένων) είναι ένα αρχείο διακομιστή ColdFusion που αναπτύχθηκε από την Adobe Systems. Είναι ένα αρχείο από την πλευρά του διακομιστή που εκτελείται σε διακομιστή web που διαθέτει ColdFusion. Είναι παρόμοιο με τα αρχεία [ASP](/el/web/asp/) και [PHP](/el/web/php/) και δημιουργεί [HTML](/el/web/html/) όταν ένας χρήστης ζητά τη σελίδα στο πρόγραμμα περιήγησης Ιστού. Τα αρχεία DBM μπορούν να ανοίξουν σε εφαρμογές όπως το Adobe ColdFusion, το Adobe ColdFusion Builder, το MacroMates TextMate και το Apple Safari.
