{
  "date" : "2019-10-11",
  "keywords" :[ "αρχείο vstm", "μορφή αρχείου vstm", "τι είναι αρχείο vstm", "αρχείο", "παράδειγμα vstm", "επέκταση αρχείου vstm", "επέκταση", "μορφή" ],
  "author" : {
    "display_name" : "Kashif Iqbal"
},
  "draft" : "false",
  "toc" : true,
  "title" :"VSTM - Μορφή αρχείου προτύπου Microsoft Visio",
  "description":"Μάθετε σχετικά με τη μορφή αρχείου VSTM και τα API που μπορούν να δημιουργήσουν και να ανοίξουν αρχεία VSTM.",
  "linktitle" : "VSTM",
  "menu" : {
    "docs" : {
