...
Η εσωτερική δομή μορφής αρχείου της μορφής αρχείου MSO είναι καλά καθορισμένη στο [Structures](https://docs.microsoft.com/en-us/openspecs/windows_protocols/ms-cfb/28488197-8193-49d7-84d8-dfd692418ccd ) ενότητα της τεκμηρίωσης του MCDF. Ο πίνακας κατανομής αρχείων (FAT) διαχειρίζεται την κατανομή τομέα και τις αλυσίδες τομέα. Περιέχει μια σειρά από αριθμούς τομέων 32 bit. Κάθε δείκτης στον πίνακα αντιπροσωπεύει έναν αριθμό τομέα, ενώ η τιμή του αντιπροσωπεύει τον επόμενο τομέα στην αλυσίδα ή μια ειδική τιμή.
