...
Το λογισμικό Sony Themes Creator μπορεί να χρησιμοποιηθεί για τη δημιουργία νέων θεμάτων για κινητά τηλέφωνα Sony Ericsson. Οι χρήστες μπορούν να ακολουθήσουν τον [Οδηγό προγραμματιστών δημιουργίας θεμάτων](https://developer.sony.com/develop/theme-creator/get-started) της Sony για να δημιουργήσουν θέματα.

## βιβλιογραφικές αναφορές

* [Οδηγός προγραμματιστή του Sony Themes Creator](https://developer.sony.com/develop/theme-creator/get-started)
