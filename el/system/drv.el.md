...
Τα αρχεία DRV συνήθως συσκευάζονται ως δυναμικές βιβλιοθήκες (αρχεία [DDL](/el/system/dll/) ή αρχεία [EXE](/el/executable/exe/). Αυτά τα αρχεία μπορούν να υποστηριχθούν σε όλες τις πλατφόρμες συστήματος, όπως smartphone, και δεν υπάρχει καμία διασφάλιση ότι κάθε πλατφόρμα θα υποστηρίξει σωστά αυτά τα αρχεία. Ωστόσο, ορισμένες πιο συνηθισμένες συσκευές που χρησιμοποιούν την επέκταση αρχείου .drv είναι:
