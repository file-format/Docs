...
Η μορφή OpenDocument υποστηρίζει την αναπαράσταση εγγράφων ως ένα μεμονωμένο έγγραφο XML καθώς και μια συλλογή πολλών δευτερευόντων εγγράφων σε ένα πακέτο ως αρχείο [ZIP](/compression/zip/). Κάθε ένα από τα αρχεία από το αρχείο ZIP αποθηκεύει μέρος του πλήρους εγγράφου. Κάθε δευτερεύον έγγραφο αποθηκεύει μια συγκεκριμένη πτυχή του εγγράφου. Για παράδειγμα, ένα δευτερεύον έγγραφο περιέχει τις πληροφορίες στυλ και ένα άλλο δευτερεύον έγγραφο περιέχει το περιεχόμενο του εγγράφου. Ένα τυπικό έγγραφο ODF έχει τα ακόλουθα στοιχεία:
