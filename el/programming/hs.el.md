...
Ο κώδικας μπορεί να γραφτεί σε ένα αρχείο .hs και να μεταγλωττιστεί χρησιμοποιώντας έναν μεταγλωττιστή Haskell όπως το [GHC](http://haskell.org/ghc). Η ακόλουθη γραμμή κώδικα αποθηκεύεται ως «HelloWorld.hs», όπως φαίνεται στο παρακάτω δείγμα.
