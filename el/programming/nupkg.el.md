...
* [Γρήγορη εκκίνηση: Εγκαταστήστε και χρησιμοποιήστε ένα πακέτο στο Visual Studio (μόνο για Windows)](https://docs.microsoft.com/en-us/nuget/quickstart/install-and-use-a-package-in-visual- Στούντιο)
