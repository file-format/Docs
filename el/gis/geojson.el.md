...
Ένας διατεταγμένος πίνακας συντεταγμένων αντιπροσωπεύει τη [θέση](http://geojson.org/geojson-spec.html#positions). Αυτή είναι η μικρότερη μονάδα που μπορεί να υποδείξει ένα σημείο στη γη.
