...
Ένα αρχείο 3DC είναι ένα αρχείο δεδομένων GPS που χρησιμοποιείται από την εφαρμογή λογισμικού πλοήγησης GPS, [iGO](https://en.wikipedia.org/wiki/IGO_(λογισμικό)). Περιέχει πληροφορίες τρισδιάστατων δεδομένων κτιρίου μαζί με μεταδεδομένα για εμφάνιση εφαρμογών. Τα αρχεία 3DC αποθηκεύονται στην κάρτα μνήμης της μονάδας πλοήγησης και αποθηκεύονται κυρίως στον κατάλογο \​iGO\​content\​building\​.
...
* [Λογισμικό πλοήγησης iGO](https://en.wikipedia.org/wiki/IGO_(λογισμικό))
