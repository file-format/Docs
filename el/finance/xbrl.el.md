...
**`XBRL Taxonomy`** - Η [XBRL Taxonomy](https://www.xbrl.org/Specification/XBRL-2.1/REC-2003-12-31/XBRL-2.1-REC-2003-12-31+corrected-errata-2013-02-20.html#_5) ορίζεται ως δομές σχήματος XML και σύνολο στοιχείων εξωτερικών συνδέσμων που αναφέρονται απευθείας. Ένα κλιμακούμενο σχήμα ταξινόμησης που δείχνει τις αναφορές της βάσης συνδέσεων είναι το ακόλουθο.
