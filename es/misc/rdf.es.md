{
  ...
  "draft" : "false",
  "toc" : true,
  "title" : "Archivo RDF - Archivo de marco de descripción de recursos - ¿Qué es el archivo .rdf y cómo abrirlo?",
  "description":"Obtenga más información sobre el archivo del marco de descripción de recursos RDF y cómo abrirlo.",
  "linktitle" : "RDF",
  "menu" : {
    "docs" : {
...
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
   ...
   <foaf:Persona rdf:about="#john">
     <foaf:nombre>John Smith</foaf:nombre>
     <foaf:edad>30</foaf:edad>
   </foaf:Persona>
</rdf:RDF>
```
...
## Referencias
* [Marco de descripción de recursos](https://en.wikipedia.org/wiki/Resource_Description_Framework)