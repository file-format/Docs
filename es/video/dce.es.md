{
  ...
  "draft" : "false",
  "toc" : true,
  "title" : "Archivo DCE - Archivo de eventos DriveCam - ¿Qué es el archivo .dce y cómo abrirlo?",
  "description" : "Obtenga más información sobre el archivo de eventos DCE DriveCam y cómo abrirlo.",
  "linktitle" : "DCE",
  "menu" : {
    "docs" : {
...
Si tiene un archivo DCE de un sistema DriveCam, es posible que necesite software o herramientas especializados proporcionadas por el fabricante para ver y analizar el contenido del video; Los detalles específicos sobre el formato de archivo DCE y la compatibilidad pueden variar según el fabricante y el modelo del sistema DriveCam.

También puedes convertir el archivo DCE al formato AVI y luego usar el reproductor AVI para reproducir el video.
