{
  "date" : "2021-06-17",
  "keywords" :[ "DBC", "extensión", "archivo dbc", "formato de archivo dbc", "Tipo de archivo de base de datos", "Formato de archivo de base de datos", "qué es un archivo dbc" ],
  "author" : {
    "display_name" : "Muhammad Umar"
},
  "draft" : "false",
  "toc" : true,
  "description" :"Obtenga más información sobre el formato de archivo DBC y las API que pueden crear y abrir archivos DBC",
  "title" :"DBC - Archivo de base de datos CAN",
  "linktitle" : "DBC",
  "menu" : {
    "docs" : {
      "parent" : "database"
...
* [Una introducción a los archivos J1939 y DBC] (https://www.kvaser.com/developer-blog/an-introduction-j1939-and-dbc-files/)
