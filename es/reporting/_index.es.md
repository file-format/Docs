{
  ...
  "title" :"Obtenga información sobre los formatos de archivo de informes y las API que pueden abrir y crear archivos de informes",
  "description":"Los archivos de informes pertenecen a ciertos softwares de informes que contienen la estructura de diseño para representar los datos de una fuente de datos típica",
  "linktitle" : "Formatos de archivo de informes",
  "menu" : {
    "docs" : {
      "parent" : "reporting",
      "weight" : "01"
