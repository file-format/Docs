...
Un archivo XSD simple que tiene un esquema de orden de compra define los elementos usando etiquetas como se muestra en el siguiente [ejemplo XSD de Microsoft](https://learn.microsoft.com/en-us/visualstudio/xml-tools/sample-xsd-file -esquema-simple?view=vs-2022).
...
- [Ejemplo de muestra de XSD](https://learn.microsoft.com/en-us/visualstudio/xml-tools/sample-xsd-file-simple-schema?view=vs-2022)
