{
  ...
  "draft" : "false",
  "toc" : true,
  "description":"Obtenga más información sobre el formato de archivo RBXL y las API que pueden crear y abrir archivos RBXL",
  "title" :"Archivo RBXL - Archivo de ubicación de Roblox",
  "linktitle" : "RBXL",
  "menu" : {
    "docs" : {
      "parent" : "programming"
...
Los archivos RBXL se desarrollan con Roblox Studio y se guardan en formato de archivo [XML](/es/web/xml/). Debido a este formato de archivo universal, existen muchas herramientas y API que le permiten crear y abrir estos archivos. Una de esas API es [MaximumADHD](https://github.com/MaximumADHD/Roblox-File-Format), una biblioteca [C#](/es/programming/cs/) para crear y manipular archivos en el formato de archivo modelo/ubicación de Roblox. .
