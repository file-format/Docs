{
  "date" : "2019-10-11",
  "keywords" :[ "archivo txt", "formato de archivo txt", "qué es un archivo txt", "archivo", "ejemplo txt", "extensión de archivo txt","extensión", "formato"],
  "author" : {
    "display_name" : "Kashif Iqbal"
},
  "draft" : "false",
  "toc" : true,
  "title" :"TXT - Archivo de documento de texto",
  "description":"Obtenga información sobre el formato de archivo TXT y las API que pueden crear y abrir archivos TXT",
  "linktitle" : "TXT",
  "menu" : {
    "docs" : {
