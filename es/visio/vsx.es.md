{
  "date" : "2019-10-11",
  "keywords" :[ "archivo vsx", "formato de archivo vsx", "qué es un archivo vsx", "archivo", "ejemplo vsx", "extensión de archivo vsx","extensión", "formato"],
  "author" : {
    "display_name" : "Kashif Iqbal"
},
  "draft" : "false",
  "toc" : true,
  "title" :"VSX - Formato de archivo de plantilla de Microsoft Visio",
  "description":"Obtenga información sobre el formato de archivo VSX y las API que pueden crear y abrir archivos VSX",
  "linktitle" : "VSX",
  "menu" : {
    "docs" : {
...
## ¿Qué es un archivo VSX?

Los archivos con extensión .vsx se refieren a plantillas que consisten en dibujos y formas que se utilizan para crear diagramas en Microsoft Visio. Los archivos VSX se guardan en formato de archivo XML y fueron compatibles hasta Visio 2013. Estos son diferentes al formato de archivo principal [VSDX](/es/image/vsdx/) que se introdujo con Microsoft Visio 2013. Los archivos VSX se pueden abrir en cualquier editor de texto para ver los contenidos. Los archivos VSX se pueden convertir a varios formatos de archivo diferentes, como PDF y HTML.

## Formato de archivo VSX ##

A continuación se muestra un archivo VSX de muestra abierto en el editor XML. Un archivo VSX típico tiene los siguientes nodos como se observa en su representación XML.

### Propiedades del documento ###

Algunos de los elementos contenidos en la sección Propiedades del documento son los siguientes:
...
Un nodo de configuración de documento típico contiene los siguientes elementos.
...
El nodo de colores contiene entradas de color que se utilizarán en todo el documento.
...
El nodo FaceNames del archivo representa las propiedades TypeFace.FaceNames utilizadas en el documento.
...
El nodo StyleSheets contiene información sobre las hojas de estilo utilizadas en el documento. Cada hoja de estilo puede tener información sobre propiedades de estilo, líneas, patrones de relleno, bloques de texto y otros elementos similares.

### Hoja de documento ###

El nodo DocumentSheet contiene información sobre las propiedades del documento y la información del nombre de usuario, y tiene el siguiente aspecto:
...
Contiene información sobre las páginas de un documento de Visio, como propiedades de página, diseños, cuadrículas de regla, formas, imágenes y otros datos similares.
