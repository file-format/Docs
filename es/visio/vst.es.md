{
  "date" : "2019-10-11",
  "keywords" :[ "archivo vst", "formato de archivo vst", "qué es un archivo vst", "archivo", "ejemplo de vst", "extensión de archivo vst","extensión", "formato"],
  "author" : {
  ...
  "toc" : true,
  "title" :"VST",
  "description":"Obtenga información sobre el formato de archivo VST y las API que pueden crear y abrir archivos VST",
  "linktitle" : "VST",
  "menu" : {
    "docs" : {
