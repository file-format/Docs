...
* [Cómo leer el archivo de volcado de memoria pequeña que crea Windows si se produce un bloqueo](https://docs.microsoft.com/en-us/troubleshoot/windows-client/performance/read-small-memory-dump -expediente)
