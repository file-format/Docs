{
  ...
  "draft" : "false",
  "toc" : true,
  "title" :"Archivo DER - Formato de archivo de certificado DER",
  "description":"Obtenga información sobre el formato de archivo DER y las API que pueden crear y abrir archivos DER",
  "linktitle" : "DER",
  "menu" : {
    "docs" : {
      "identifier":"web-der",
...
Un archivo DER es un archivo de certificado digital que se crea y almacena en formato binario. Es una codificación binaria para los certificados X.509 y claves privadas. A diferencia de los archivos PEM ([CRT](https://docs.fileformat.com/web/crt/), [CER](https://docs.fileformat.com/web/cer/)), los archivos DER sí no contener declaraciones de texto sin formato legibles por humanos, como -----BEGIN CERTIFICATE-----. Se utilizan principalmente en el contexto de Java.

## Formato de archivo DER - Más información

Los archivos DER se almacenan en el disco en formato de archivo binario que no es legible por humanos. Estos archivos de certificados son cargados y reconocidos por navegadores web estándar para una navegación segura.

### ¿Qué aspecto tiene un certificado codificado en DER?

A continuación se muestra un ejemplo de un certificado SSL/TLS con codificación DER.
...
## Convierta el certificado codificado en DER a PEM

Un archivo de certificado codificado en DER se puede convertir a PEM con el siguiente comando.
