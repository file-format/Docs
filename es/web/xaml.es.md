{
  "date" : "2019-10-11",
  "keywords" :[ "xaml","archivo xaml", "formato de archivo xaml", "tipo de archivo xaml", "archivo", "tipo", "qué es un archivo xaml" ],
  "author" : {
    "display_name" : "Kashif Iqbal"
},
  "draft" : "false",
  "toc" : true,
  "title" :"XAML - Lenguaje de marcado basado en XML",
  "description":"Obtenga información sobre el formato de archivo XAML y las API que pueden crear y abrir archivos XAML",
  "linktitle" : "XAML ",
  "menu" : {
    "docs" : {
      "parent" : "web"
...
Los archivos de extensión XAML, Extensible Application Markup Language, describen los elementos de la interfaz de usuario para aplicaciones de software basadas en Windows Presentation Foundation (WPF). Aunque es un lenguaje, no requiere ser programado ya que se basa en el formato estándar de **[XML](/es/web/xml/)** que es fácil de usar y comprender. XAML (pronunciado como "zammel") fue desarrollado por Microsoft con el objetivo específico de crear interfaces de usuario. Su acrónimo original significaba Extensible Avalon Markup Language, donde Avalon era el nombre en clave de WPF. Los archivos XAML a veces también se guardan con la extensión XOML.
...
XAML se basa totalmente en el formato XML. Las especificaciones iniciales de [Asignación de objetos XAML](https://download.microsoft.com/download/0/A/6/0A6F7755-9AF5-448B-907D-13985ACCF53E/%5BMS-XAML%5D.pdf) se publicaron en 2006, seguida de otra [versión](https://download.microsoft.com/download/0/A/6/0A6F7755-9AF5-448B-907D-13985ACCF53E/%5BMS-XAML-2009%5D.pdf) publicada en 2009. Estas especificaciones definen dos modelos abstractos de información:
...
* [Especificaciones del formato de archivo XAML](https://download.microsoft.com/download/0/A/6/0A6F7755-9AF5-448B-907D-13985ACCF53E/%5BMS-XAML-2009%5D.pdf)
