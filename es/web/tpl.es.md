{
  "date" : "2019-10-11",
  "keywords" :[ "tpl","archivo tpl", "formato de archivo tpl", "tipo de archivo tpl", "archivo", "tipo", "qué es un archivo tpl" ],
  "author" : {
    "display_name" : "Kashif Iqbal"
},
  "draft" : "false",
  "toc" : true,
  "title" :"TPL - Plantilla de servidor de archivos HTTP",
  "description" :"Obtenga información sobre qué es el archivo TPL y las API para crear y abrir archivos TPL",
  "linktitle" : "TPL",
  "menu" : {
    "docs" : {
      "parent" : "web"
...
* [Ejemplo de TPL - Github](https://github.com/heiswayi/hfs-templates/blob/master/HFSTemplate_myHFS.tpl)
