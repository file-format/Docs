...
* [Hiểu và định cấu hình Trình quản lý kết nối Windows](https://docs.microsoft.com/en-us/windows-hardware/drivers/mobilebroadband/under Hiểu-and-configure-windows-connection-manager)
