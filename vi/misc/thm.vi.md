...
Phần mềm Sony Themes Creator có thể được sử dụng để tạo các chủ đề mới cho điện thoại di động Sony Ericsson. Người dùng có thể làm theo [Hướng dẫn dành cho nhà phát triển Trình tạo chủ đề] của Sony (https://developer.sony.com/develop/theme-creator/get-started) để tạo chủ đề.

## Người giới thiệu

* [Hướng dẫn dành cho nhà phát triển Sony Themes Creator](https://developer.sony.com/develop/theme-creator/get-started)
