...
* [Hướng dẫn quản lý và kiến trúc nhật ký giao dịch](https://docs.microsoft.com/en-us/sql/relational-databases/sql-server-transaction-log-architecture-and-man Quản lý-guide?view=sql- máy chủ-ver15)
