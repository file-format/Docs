...
Thông số kỹ thuật định dạng tệp E57 có sẵn tại trang web ATSM và có thể được tham khảo để nhà phát triển tham khảo. Tài liệu khái niệm và chi tiết kỹ thuật của định dạng tệp E57 có sẵn dưới dạng tài liệu tham khảo của [Daniel Huber](http://paulbourke.net/dataformats/e57/2011-huber-e57-v3.pdf). Dữ liệu trong tệp E57 được lưu trong cấu trúc cây phân cấp dựa trên XML như trong hình dưới đây. Ở mức thấp, các tệp E57 được lưu dưới dạng tệp nhị phân được nén để làm cho kích thước tệp nhỏ gọn.
