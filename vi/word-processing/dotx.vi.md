...
Các tệp có phần mở rộng DOTX là các tệp mẫu do Microsoft Word tạo để có cài đặt định dạng trước để tạo các tệp [DOCX](/vi/Word%20Processing/DOCX/) khác. Một tệp mẫu được tạo để có các cài đặt người dùng cụ thể sẽ được áp dụng cho những con ruồi tiếp theo được tạo từ những tệp này. Các cài đặt này bao gồm lề trang, đường viền, đầu trang, chân trang và các cài đặt trang khác. Các mẫu như vậy được sử dụng trong các tài liệu chính thức như tiêu đề thư của công ty và các biểu mẫu tiêu chuẩn hóa.
