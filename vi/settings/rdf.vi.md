{
  ...
  "draft" : "false",
  "toc" : true,
  "title" : "Tệp RDF - Tệp khung mô tả tài nguyên - Tệp .rdf là gì và làm cách nào để mở tệp?",
  "description":"Tìm hiểu về Tệp khung mô tả tài nguyên RDF và cách mở tệp đó.",
  "linktitle" : "RDF",
  "menu" : {
    "docs" : {
      "identifier": "misc-rdf-vi",
      "parent" : "misc"
}
},
  "lastmod" : "2024-01-10"
...
Trong ví dụ này, chúng tôi xác định một người có tên John Smith với đặc tính tuổi là 30 bằng cách sử dụng từ vựng FOAF (Friend of a Friend). Cú pháp RDF/XML là một cách để biểu diễn dữ liệu RDF, nhưng có các định dạng tuần tự hóa khác như Turtle và JSON-LD.
...
3.  **Bộ ba và cơ sở dữ liệu:** Nếu tệp RDF của bạn thực sự lớn hoặc bạn muốn thực hiện những điều nâng cao hơn với nó, bạn có thể sử dụng thứ gọi là bộ ba. Hãy coi đây giống như một cơ sở dữ liệu thông minh cho dữ liệu RDF. Các chương trình như Apache Jena, Virtuoso hoặc Stardog có thể giúp lưu trữ và quản lý lượng lớn thông tin RDF.
