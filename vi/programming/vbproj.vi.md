...
Tệp VBPROJ là tệp văn bản được viết ở định dạng tệp [XML](/vi/web/xml/) dựa trên [Lược đồ XML MSBuild](https://docs.microsoft.com/en-us/visualstudio/msbuild/msbuild- project-file-schema-reference?view=vs-2019). Tệp VBPROJ chứa thông tin ở dạng thẻ XML xác định thông tin liên quan đến nhóm cài đặt cụ thể đó. Bạn nên mở và chỉnh sửa các tệp cài đặt này trong Microsoft Visual Studio IDE.
...
* [Hiểu tệp dự án](https://docs.microsoft.com/en-us/aspnet/web-forms/overview/deployment/web-deployment-in-the-enterprise/under Hiểu-the-project-file)
* [Các thành phần lược đồ MSBuild](https://docs.microsoft.com/en-us/visualstudio/msbuild/msbuild-project-file-schema-reference?view=vs-2019)
