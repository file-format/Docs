{
  ...
  "draft" : "false",
  "toc" : true,
  "title" :"Tệp ASC - Định dạng tệp Adobe ActionScript",
...
Các tệp ASC được lưu dưới dạng tệp văn bản có thể được mở và chỉnh sửa bằng [Adobe Media Encoder](https://www.adobe.com/products/media-encoder.html). Chúng được tạo và lưu dưới dạng tệp văn bản và có thể được mở bằng bất kỳ trình soạn thảo văn bản nào như Microsoft Notepad, Notepad++ và Apple TextEdit. Tệp ASC được thực thi theo mặc định khi Flash Media Server chạy và ứng dụng.
