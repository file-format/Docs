...
चूंकि वेबसाइटों के डिजाइन जटिल होते जा रहे हैं जिसके परिणामस्वरूप बड़ी [सीएसएस](/hi/वेब/सीएसएस/) फाइलें बन रही हैं। ऐसी फाइलों को बनाए रखना कठिन होता है। यह वह जगह है जहाँ SCSS आता है। SCSS CSS विकास में चर, नेस्टिंग, मिश्रण, आयात और चयनकर्ता विरासत का परिचय देता है। ये जोड़ डिजाइन के साथ काम करना और अधिक मजेदार बनाते हैं।

## एससीएसएस फाइलों का उपयोग कैसे करें ##

एससीएसएस फाइलें सीधे [एचटीएमएल](/hi/वेब/एचटीएमएल/) दस्तावेज में सीएसएस की तरह शामिल नहीं हैं। इसके बजाय, SCSS फाइलें CSS फाइलों में बदल जाती हैं जो HTML फाइलों में शामिल होती हैं। अपने सिस्टम पर एससीएसएस स्थापित करने के लिए, [आधिकारिक सैस साइट] (https://sass-lang.com/install) पर दिए गए निर्देशों का पालन करें।
