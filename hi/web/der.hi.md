{
  ...
  "draft" : "false",
  "toc" : true,
  "title" :"डीईआर फ़ाइल - डीईआर प्रमाणपत्र फ़ाइल प्रारूप",
  "description":"डीईआर फ़ाइल प्रारूप और एपीआई के बारे में जानें जो डीईआर फाइलें बना और खोल सकते हैं।",
  "linktitle" : "DER",
  "menu" : {
    "docs" : {
      "identifier":"web-der",
...
डीईआर फाइल एक डिजिटल सर्टिफिकेट फाइल है जिसे बाइनरी फॉर्मेट में बनाया और स्टोर किया जाता है। यह X.509 प्रमाणपत्रों और निजी चाबियों के लिए एक बाइनरी एन्कोडिंग है। पीईएम फाइलों ([सीआरटी](https://docs.fileformat.com/web/crt/), [सीईआर](https://docs.fileformat.com/web/cer/)) के विपरीत, डीईआर फाइलें मानव-पठनीय सादे पाठ विवरण जैसे -----BEGIN CERTIFICATE----- शामिल नहीं हैं। वे ज्यादातर जावा के संदर्भ में उपयोग किए जाते हैं।

## डीईआर फ़ाइल स्वरूप - अधिक जानकारी

डीईआर फ़ाइलें डिस्क में बाइनरी फ़ाइल स्वरूप में संग्रहीत की जाती हैं जो मानव-पठनीय नहीं है। ये प्रमाणपत्र फ़ाइलें सुरक्षित नेविगेशन के लिए मानक वेब ब्राउज़र द्वारा लोड और पहचानी जाती हैं।

### डीईआर-एन्कोडेड प्रमाणपत्र कैसा दिखता है?

डीईआर-एन्कोडेड एसएसएल/टीएलएस प्रमाणपत्र का एक उदाहरण नीचे दिखाया गया है।
...
## डीईआर-एन्कोडेड प्रमाणपत्र को पीईएम में कनवर्ट करें

एक डीईआर-एन्कोडेड प्रमाणपत्र फ़ाइल को निम्न आदेश का उपयोग करके पीईएम में परिवर्तित किया जा सकता है।
...
* [एक डिजिटल प्रमाणपत्र प्राप्त करें और एक डिजिटल हस्ताक्षर बनाएं
