...
.dap एक्सटेंशन वाली फ़ाइल एक Microsoft Access डेटा पृष्ठ फ़ाइल है जो Microsoft Access के भीतर से बनाई गई है और डेटाबेस में संग्रहीत डेटा तक पहुँच रखती है। ऐसी वेब फ़ाइल में संग्रहीत डेटा को नेटवर्क (इंट्रानेट और इंटरनेट) पर एक्सेस किया जा सकता है जो एक्सेस की [एमडीबी](/hi/डेटाबेस/एमडीबी/) फ़ाइलों से अलग है जो विशेष रूप से डेस्कटॉप अनुप्रयोगों के लिए विकसित की गई हैं। इस तरह के डेटाबेस एक्सेस 2010 और एक्सेस सर्विसेज (शेयरपॉइंट का एक वैकल्पिक घटक) का उपयोग करके बनाया जा सकता है। इन डेटाबेस का उपयोग वेब ब्राउजर में वेब पते का उपयोग करके शेयरपॉइंट खातों वाले लोगों द्वारा किया जा सकता है।
