...
एएमएल स्टोरेज और इंजीनियरिंग मॉडलों के आदान-प्रदान के लिए [एक्सएमएल](/hi/वेब/एक्सएमएल/) आधारित ऑब्जेक्ट-ओरिएंटेड डेटा मॉडलिंग का उपयोग करता है। इंजीनियरिंग प्लांट घटकों को अलग-अलग पहलुओं वाली वस्तुओं के रूप में दर्शाया जाता है, प्रत्येक वस्तु में उप-वस्तुओं के रूप में कार्य करने की क्षमता होती है। इस प्रकार, प्रत्येक छोटे या बड़े मॉडल का वर्णन किया जा सकता है। [AutomationML Specifications](https://www.automationml.org/about-automationml/specifications/) इस मॉडलिंग भाषा के विवरण के साथ आरंभ करने के लिए एक संक्षिप्त गाइड प्रदान करता है।
