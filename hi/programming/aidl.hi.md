...
एक एआईडीएल (एंड्रॉइड इंटरफेस डेफिनिशन लैंग्वेज) फ़ाइल एंड्रॉइड डेवलपर्स को विभिन्न ऐप्स के बीच संचार स्थापित करने की अनुमति देती है। प्रोग्रामिंग इंटरफेस के आधार पर, ग्राहक और सेवा दोनों इंटरप्रोसेस संचार (आईपीसी) का उपयोग कर संवाद करने के लिए सहमत हैं। एआईडीएल फ़ाइल में इन इंटरफेस को परिभाषित करने के लिए जावा स्रोत कोड और ऐप्स के बीच संचार के लिए अनुबंध शामिल हैं।
