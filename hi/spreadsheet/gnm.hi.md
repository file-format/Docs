...
चूंकि Gnumeric कई अलग-अलग फ़ाइल स्वरूपों का समर्थन करता है, यह मूल GNM फ़ाइलों को [CSV](/hi/spreadsheet/csv/), [XLSX](/hi/spreadsheet/xlsx/), Microsoft Works (.wks), [HTML](/hi/) में परिवर्तित कर सकता है। वेब/एचटीएमएल/), [लाटेक्स](/hi/word-processing/लेटेक्स/), और [लोटस 1-2-3](/hi/स्प्रेडशीट/123/)।
