...
XAPK फ़ाइलें मानक [ज़िप] (/hi/ संपीड़न/ज़िप/) फ़ाइल स्वरूप का उपयोग करके संपीड़ित की जाती हैं। इन्हें WinZIP जैसे मानक संपीड़न/डीकंप्रेसन सॉफ़्टवेयर का उपयोग करके निकाला जा सकता है। एक बार XAPK फ़ाइल को डिस्क पर निकालने के बाद, इसमें निम्न फ़ाइलें फ़ोल्डर में होती हैं।
