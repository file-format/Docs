...
ETL फ़ाइल डेटा को Microsoft Windows प्रदर्शन विश्लेषक (WPA) एप्लिकेशन का उपयोग करके तालिका के साथ-साथ ग्राफ़िकल प्रारूप में पढ़ा और देखा जा सकता है। [ईटीएल फाइलों को खोलना और उनका विश्लेषण करना](https://docs.microsoft.com/en-us/windows-hardware/test/wpt/opening-and-analyzing-etl-files-in-wpa) गाइड काम करने के बारे में जानकारी देती है ईटीएल फाइलों के साथ।

## संदर्भ

* [विंडोज परफॉर्मेंस एनालाइजर](https://docs.microsoft.com/en-us/windows-hardware/test/wpt/getting-started--windows-performance-analyzer--wpa-)
* [WPA क्विक स्टार्ट गाइड](https://docs.microsoft.com/en-us/windows-hardware/test/wpt/wpa-quick-start-guide)
