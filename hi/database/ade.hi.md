...
एडीई फाइलें माइक्रोसॉफ्ट एक्सेस के उस संस्करण के आधार पर खुलने में समस्याएं पैदा कर सकती हैं जिसका उपयोग इन फाइलों को बनाने के लिए किया गया है। एक्सेस डेटाबेस जो माइक्रोसॉफ्ट एक्सेस 2010 के 64-बिट संस्करण का उपयोग कर रहे हैं और जिन्हें एमडीई, ACCDE, या एडीई फाइलों के रूप में संकलित किया गया है, को माइक्रोसॉफ्ट एक्सेस 2021 सर्विस पैक 1 (एसपी1) में पुन: संकलित किया जाना है। Access 2010 SP1 के साथ ठीक से काम करें। यह समस्या इसलिए होती है क्योंकि Access 2010 SP1 VBE7.dll फ़ाइल (संस्करण 7.00.1619) के नए संस्करण का उपयोग करता है।
