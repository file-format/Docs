...
.usd एक्सटेंशन वाली फ़ाइल एक यूनिवर्सल सीन विवरण फ़ाइल स्वरूप है जो डिजिटल सामग्री निर्माण अनुप्रयोगों के बीच डेटा इंटरचेंजिंग और संवर्द्धन के उद्देश्य से डेटा को एन्कोड करता है। पिक्सर द्वारा विकसित, [यूएसडी](https://openusd.org/release/intro.html) मौलिक संपत्तियों (जैसे मॉडल) या एनीमेशन को इंटरचेंज करने की क्षमता प्रदान करता है।
...
* [यूएसडी का परिचय](https://openusd.org/release/intro.html)
* [यूएसडी एपीआई संदर्भ](https://openusd.org/release/apiDocs.html)
