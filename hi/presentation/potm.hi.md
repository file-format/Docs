{
  "date" : "2019-10-11",
  "keywords" :[ "पोटम फाइल", "पोटम फाइल फॉर्मेट", "पोटम फाइल क्या है", "फाइल", "पोटम उदाहरण", "पोटम फाइल एक्सटेंशन", "एक्सटेंशन", "फॉर्मेट"],
  "author" : {
    "display_name" : "Kashif Iqbal"
},
  "draft" : "false",
  "toc" : true,
  "title" :"POTM - मैक्रोज़ के साथ Microsoft PowerPoint टेम्पलेट फ़ाइल",
  "description":"POTM फ़ाइल स्वरूप और API के बारे में जानें जो POTM फ़ाइलें बना और खोल सकते हैं।",
  "linktitle" : "POTM",
  "menu" : {
    "docs" : {
      "parent" : "presentation"
...
## पीओटीएम फाइल क्या है?

POTM एक्सटेंशन वाली फाइलें मैक्रोज़ के समर्थन के साथ Microsoft PowerPoint टेम्पलेट फ़ाइलें हैं। POTM फाइलें PowerPoint 2007 या इसके बाद के संस्करण के साथ बनाई गई हैं और इसमें डिफ़ॉल्ट सेटिंग्स हैं जिनका उपयोग आगे की प्रस्तुति फ़ाइलों को बनाने के लिए किया जा सकता है। इन सेटिंग्स में मैक्रोज़ के साथ स्टाइल, बैकग्राउंड, कलर पैलेट, फोंट और डिफॉल्ट शामिल हो सकते हैं जिनमें विशेष कार्य करने के लिए कस्टम फ़ंक्शंस शामिल हैं। उन्हें PowerPoint के पिछले संस्करण द्वारा भी खोला जा सकता है, जिसमें Open XML दस्तावेज़ स्थापित है। POTM फाइलें किसी अन्य PowerPoint फ़ाइल की तरह संपादन के लिए Microsoft PowerPoint में खोली जा सकती हैं।

## फ़ाइल प्रारूप निर्दिष्टीकरण ##

POTM फ़ाइल स्वरूप Office OpenXML विनिर्देशों पर आधारित है और [PPTX](/hi/presentation/pptx/) फ़ाइल की संरचना जैसा दिखता है जो एक संपीड़ित [ZIP](/hi/compression/zip/) संग्रह है।

POTM फ़ाइल के अंदर की स्लाइड्स में टेक्स्ट, चित्र, वीडियो, ग्राफिक्स और अन्य ऑब्जेक्ट हो सकते हैं जिन्हें पेज के भीतर स्वतंत्र रूप से व्यवस्थित किया जा सकता है। POTM टेम्प्लेट का उपयोग तब कई फाइलें बनाने के लिए किया जाता है जो फ़ाइल के सभी स्वरूपण विकल्पों को इनहेरिट करती हैं। इसलिए, POTM फ़ाइल में निहित मैक्रोज़ अन्य प्रस्तुतियों द्वारा भी इनहेरिट किए जाते हैं। दस्तावेज़ की संरचना में उन्हें एम्बेड करना एमएस ऑफिस में शामिल मैक्रो रिकॉर्डर के माध्यम से किया जाता है जो कमांड अनुक्रमों को सहेज सकता है और उन्हें स्वचालित रूप से दोहराने के लिए मैक्रोज़ बना सकता है।

ऑफिस ओपन एक्सएमएल फाइल फॉर्मेट के साथ जेनरेट की गई फाइलें अन्य फाइलों के साथ एक्सएमएल फाइलों का एक संग्रह है जो सभी घटक फाइलों के बीच लिंक प्रदान करती हैं। यह संग्रह वास्तव में एक संकुचित संग्रह है जिसे इसकी सामग्री देखने के लिए निकाला जा सकता है। ऐसा करने के लिए, केवल ज़िप के साथ POTM फ़ाइल एक्सटेंशन का नाम बदलें और इसकी सामग्री को देखने के लिए इसे निकालें।
