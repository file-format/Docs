...
iXBRL (ilnine XBRL) फ़ाइल स्वरूप [XBRL](/hi/web/xbrl/) डेटा को एक HTML फ़ाइल में एम्बेड करने देता है ताकि इसे मशीन और मानव-पठनीय दोनों बनाया जा सके। यह वास्तव में एक [xHTML](/hi/web/xhtml/) फ़ाइल है जो एक्सबीआरएल टैग का उपयोग करती है और यूके के एचएमआरसी की आवश्यकताओं को पूरा करने के लिए एक्सबीआरएल इंटरनेशनल द्वारा विकसित की गई थी। आईएक्सबीआरएल का उपयोग करके, मूल दस्तावेज़ के लेआउट को बरकरार रखते हुए वित्तीय विवरण तैयार किए जा सकते हैं। iXBRL फाइलें किसी भी टेक्स्ट एडिटर जैसे विंडोज ऑपरेटिंग सिस्टम पर नोटपैड और मैकओएस पर टेक्स्टएडिट में खोली जा सकती हैं।
