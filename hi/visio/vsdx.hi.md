{
  "date" : "2019-10-11",
  "keywords" :["vsdx फ़ाइल", "vsdx फ़ाइल स्वरूप", "vsdx फ़ाइल क्या है", "फ़ाइल", "vsdx उदाहरण", "vsdx फ़ाइल एक्सटेंशन", "एक्सटेंशन", "प्रारूप"],
  "author" : {
  ...
  "toc" : true,
  "title" :"वीएसडीएक्स",
  "description":"VSDX फ़ाइल स्वरूप और API के बारे में जानें जो VSDX फ़ाइलें बना और खोल सकते हैं।",
  "linktitle" : "VSDX",
  "menu" : {
    "docs" : {
...
हुड के तहत, Visio 2013 फ़ाइल स्वरूप [ZIP](/hi/compression/zip/) जैसे संग्रह में संबंधित संसाधनों के साथ एप्लिकेशन डेटा को स्टोर करने के लिए एक संरचित माध्यम का उपयोग करता है। ज़िप फ़ाइल को किसी भी मानक निष्कर्षण उपयोगिता का उपयोग करके निकाला जा सकता है जहाँ इसमें अन्य प्रकार की फाइलें भी होती हैं। VSDX फ़ाइल के अंदर की सामग्री को देखने के लिए आप विंडोज़ एक्सप्लोर में .vsdx फ़ाइल एक्सटेंशन को .zip से बदल सकते हैं।
