...
फ़ाइल एक्सटेंशन में "X" OpenOffice फ़ाइल स्वरूप को संदर्भित करता है जिसे Microsoft द्वारा [Zip](/hi/compression/zip/) संग्रह फ़ाइल स्वरूप के रूप में पेश किया गया था, जो पहले समर्थित बाइनरी फ़ाइल स्वरूपों के प्रतिस्थापन के लिए था। वीएसटीएक्स फाइलें, इस प्रकार, [.vst](/hi/visio/vst/) फ़ाइल प्रारूप के विपरीत ओपनऑफिस विनिर्देशों के एक्सएमएल फ़ाइल प्रारूप पर आधारित हैं जो बाइनरी प्रारूप में है।
...
हुड के तहत, Visio 2013 फ़ाइल स्वरूप [ZIP](/hi/compression/zip/) जैसे संग्रह में संबंधित संसाधनों के साथ एप्लिकेशन डेटा को संग्रहीत करने के लिए एक संरचित माध्यम का उपयोग करता है। ज़िप फ़ाइल को किसी भी मानक निष्कर्षण उपयोगिता का उपयोग करके निकाला जा सकता है जहाँ इसमें अन्य प्रकार की फाइलें भी होती हैं। आप वीएसटीएक्स फ़ाइल के अंदर की सामग्री को देखने के लिए विंडोज़ एक्सप्लोर में .ZIP के साथ .VSTX फ़ाइल एक्सटेंशन को बदल सकते हैं।
