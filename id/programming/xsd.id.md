...
File XSD sederhana yang memiliki skema pesanan pembelian menentukan elemen menggunakan tag seperti yang ditampilkan dalam [contoh XSD oleh Microsoft](https://docs.microsoft.com/en-us/visualstudio/xml-tools/sample-xsd-file) berikut -skema-sederhana?view=vs-2022).
...
- [Contoh Contoh XSD](https://docs.microsoft.com/en-us/visualstudio/xml-tools/sample-xsd-file-simple-schema?view=vs-2022)
