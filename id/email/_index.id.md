{
  ...
  "draft" : "false",
  "categories" :["dasar"],
  "description" :"File email adalah wadah digital yang berisi informasi teks, lampiran, pengirim, dan penerima. Format file email umum termasuk EML, MSG, EMLX, TNEF, ICS, OFT, PST, dan OST.",
  "title" :"Pelajari tentang Format File Email dan API yang dapat membuka dan membuat file Email",
  "linktitle" : "Format File Email",
  "menu" : {
    "docs" : {
      "parent" : "email",
      "weight" : "01"
...
Berikut adalah daftar jenis file email populer beserta ekstensi terkait.
