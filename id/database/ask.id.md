{
  "date" : "2021-09-06",
  "keywords" :[ "tanya", "ekstensi", "file", "format file", "Jenis File Database", "Format File Database", "Database askSam" ],
  "author" : {
    "display_name" : "Kashif Iqbal"
},
  "draft" : "false",
  "toc" : true,
  "description" :"Pelajari tentang format file ASK dan API yang dapat membuat dan membuka file ASK.",
  "title" :"TANYAKAN - Berkas Basis Data askSam",
  "linktitle" : "ASK",
  "menu" : {
    "docs" : {
      "parent" : "database"
...
File ASK disimpan ke disk dalam format file biner berpemilik yang detail format file internalnya tidak tersedia untuk referensi pengembang.
