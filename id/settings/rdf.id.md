{
  ...
  "draft" : "false",
  "toc" : true,
  "title" : "File RDF - File Kerangka Deskripsi Sumber Daya - Apa itu file .rdf dan bagaimana cara membukanya?",
  "description":"Pelajari tentang File Kerangka Deskripsi Sumber Daya RDF dan cara membukanya.",
  "linktitle" : "RDF",
  "menu" : {
    "docs" : {
      "identifier": "misc-rdf-id",
      "parent" : "misc"
}
},
  "lastmod" : "2024-01-10"
...
Komponen dasar dalam RDF adalah triple, yang terdiri dari subjek, predikat, dan objek. Tiga kali lipat ini digunakan untuk menyatakan pernyataan tentang sumber daya.
...
5.  **Browser Web:** Terkadang, data RDF adalah bagian dari halaman web. Dalam hal ini, browser web atau plugin browser tertentu dapat membantu Anda melihat dan memahami data RDF secara langsung di dalam browser.
