{
  "date" : "2020-01-17",
  "keywords" :[ "3D", "file", "format", "ekstensi", "GLB" ],
  "author" : {
    "display_name" : "Kashif Iqbal"
},
  "draft" : "false",
  "description" :"File 3D adalah representasi digital dari objek tiga dimensi. Belajar membuka format file 3D termasuk GLB, FBX, GLTF, OBJ, PLY, JT, 3DS, dan lainnya.",
  "categories" :["dasar"],
  "title" :"Pelajari tentang Format File 3D dan API yang dapat membuka dan membuat file 3D",
  "linktitle" : "Format File 3D",
  "menu" : {
    "docs" : {
      "parent" : "3d",
      "weight" : "01"
...
Berikut ini adalah daftar format file 3D populer yang digunakan di hampir semua pekerjaan sehari-hari yang berhubungan dengan 3D.
