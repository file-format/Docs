{
  "date" : "2019-10-11",
  "keywords" :[ "drawio", "file drawio", "format file drawio", "jenis file drawio", "file", "type", "apa itu file drawio" ],
  "author" : {
    "display_name" : "Kashif Iqbal"
},
  "draft" : "false",
  "toc" : true,
  "title" :"DRAWIO - Format File Diagram Diagram.net",
  "description" :"Pelajari tentang Format File DRAWIO dan API untuk membuat dan membuka file DRAWIO.",
  "linktitle" : "DRAWIO",
  "menu" : {
    "docs" : {
      "parent" : "web"
...
* [DRAWIO - Aplikasi Online](https://app.diagrams.net/)
