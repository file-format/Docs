{
  ...
  "draft" : "false",
  "toc" : true,
  "title" :"File DER - Format File Sertifikat DER",
  "description":"Pelajari tentang format file DER dan API yang dapat membuat dan membuka file DER.",
  "linktitle" : "DER",
  "menu" : {
    "docs" : {
      "identifier":"web-der",
...
File DER disimpan ke disk dalam format file biner yang tidak dapat dibaca manusia. File sertifikat ini dimuat dan dikenali oleh browser web standar untuk navigasi yang aman.

### Bagaimana bentuk sertifikat yang disandikan dengan DER?

Contoh sertifikat SSL/TLS yang dikodekan DER adalah seperti yang ditunjukkan di bawah ini.
...
## Mengonversi sertifikat yang disandikan DER ke PEM

File sertifikat yang dikodekan DER dapat dikonversi ke PEM menggunakan perintah berikut.
...
* [Dapatkan sertifikat digital dan buat tanda tangan digital
