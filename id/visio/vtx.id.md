{
  "date" : "2019-10-11",
  "keywords" :[ "file vtx", "format file vtx", "apa itu file vtx", "file", "contoh vtx", "ekstensi file vtx", "ekstensi", "format" ],
  "author" : {
    "display_name" : "Kashif Iqbal"
},
  "draft" : "false",
  "toc" : true,
  "title" :"VTX - Format File Templat Gambar Microsoft Visio",
  "description":"Pelajari tentang format file VTX dan API yang dapat membuat dan membuka file VTX.",
  "linktitle" : "VTX",
  "menu" : {
    "docs" : {
