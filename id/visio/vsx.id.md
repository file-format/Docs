{
  "date" : "2019-10-11",
  "keywords" :[ "file vsx", "format file vsx", "apa itu file vsx", "file", "contoh vsx", "ekstensi file vsx", "ekstensi", "format" ],
  "author" : {
    "display_name" : "Kashif Iqbal"
},
  "draft" : "false",
  "toc" : true,
  "title" :"VSX - Format Berkas Stensil Microsoft Visio",
  "description":"Pelajari tentang format file VSX dan API yang dapat membuat dan membuka file VSX.",
  "linktitle" : "VSX",
  "menu" : {
    "docs" : {
...
Contoh file VSX yang dibuka di editor XML adalah seperti yang ditunjukkan di bawah ini. File VSX tipikal memiliki node berikut seperti yang diamati dari representasi XML-nya.

### Properti Dokumen ###

Beberapa elemen yang terdapat pada bagian Document Properties adalah sebagai berikut:
...
Node pengaturan dokumen tipikal berisi elemen-elemen berikut.
...
Node warna berisi entri warna untuk digunakan di seluruh dokumen.
...
Node FaceNames dalam file mewakili properti TypeFace.FaceNames yang digunakan dalam dokumen.
...
Node StyleSheets berisi informasi tentang style sheet yang digunakan dalam dokumen. Setiap lembar gaya dapat memiliki informasi tentang properti gaya, garis, pola isian, blok teks, dan elemen serupa lainnya.

### Lembar Dokumen ###

Node DocumentSheet berisi informasi tentang properti dokumen dan informasi nama pengguna, dan terlihat sebagai berikut:
...
Berisi informasi tentang halaman dokumen Visio seperti Page Properties, Layouts, Ruler Grids, Shapes, Images dan data sejenis lainnya.
