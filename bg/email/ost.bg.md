...
Файлов формат PST [спецификации](https://msdn.microsoft.com/en-us/library/ff385210(v#office.12).aspx), както се предлага от Microsoft, също са приложими за файлов формат OST като безплатен и неотменимо патентно лицензиране чрез Open Specification Promise. Състои се от следните различими елементи:
...
* [Файлов формат за лични папки на Outlook (.ost)](https://msdn.microsoft.com/en-us/library/ff385210(v#office.12).aspx)
* [Спецификации на файловия формат на личната папка](https://github.com/libyal/libpff/blob/master/documentation/Personal%20Folder%20File%20(PFF)%20format.asciidoc)
