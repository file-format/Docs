{
  ...
  "draft" : "false",
  "toc" : true,
  "title" :"DER файл – файлов формат на DER сертификат",
  "description":"Научете за DER файловия формат и API, които могат да създават и отварят DER файлове.",
  "linktitle" : "DER",
  "menu" : {
    "docs" : {
      "identifier":"web-der",
...
DER файлът е файл с цифров сертификат, който се създава и съхранява в двоичен формат. Това е двоично кодиране за X.509 сертификати и частни ключове. За разлика от PEM файловете ([CRT](https://docs.fileformat.com/web/crt/), [CER](https://docs.fileformat.com/web/cer/)), DER файловете правят не съдържат четими от човека обикновени текстови изрази като -----НАЧАЛО НА СЕРТИФИКАТ-----. Те се използват най-вече в контекста на Java.

## DER файлов формат - повече информация

DER файловете се съхраняват на диск в двоичен файлов формат, който не може да се чете от хора. Тези файлове със сертификати се зареждат и разпознават от стандартните уеб браузъри за сигурна навигация.

### Как изглежда DER-кодиран сертификат?

Пример за DER-кодиран SSL/TLS сертификат е както е показано по-долу.
...
## Преобразувайте DER-кодиран сертификат в PEM

DER-кодиран файл със сертификат може да бъде преобразуван в PEM с помощта на следната команда.
...
* [Получете цифров сертификат и създайте цифров подпис
