...
BOK файловете се записват като уеб страници, които обикновено са в разбираем за браузър файлов формат, като например [HTML](/bg/web/html/) или [PHP](/bg/web/php/). Съдържанието на тези страници се зарежда от базата данни на ProStores по време на изпълнение, когато някой клиент посети витрината.
