...
AAE е тип файл, намиращ се в iOS 8 и по-нови, macOS 10.10 или по-нови системи. Той съхранява информация за всички редакции, направени на [.jpg](/bg/image/jpg/) снимки в приложението Снимки. AAE файловете са в допълнение към оригиналните файлове и позволяват на потребителите да върнат снимките към първоначалното им състояние, ако е необходимо. Когато изображенията се импортират от macOS в Windows, придружаващите AAE файлове също се прехвърлят.
