...
Файл с разширение .cfml е файл на ColdFusion Markup Language, който се използва за създаване на уеб страница. Отнася се до набор от правила, използвани за определяне на това как приложението ColdFusion ще бъде разработено от програмиста. ColdFusion е език за програмиране, който се използва за създаване на уеб приложения от страна на сървъра бързо и с по-малко от други технологии като [ASP](/bg/web/asp/), [PHP](/bg/web/php/) и др. от приложенията, които могат да отварят CML файлове, включват Adobe ColdFusion 2018, Adobe ColdFusion Builder и Adobe Dreamweaver.
