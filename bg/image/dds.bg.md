...
[Оформлението на DDS файла] (https://docs.microsoft.com/en-us/windows/win32/direct3ddds/dx-graphics-dds-pguide#dds-file-layout) е документирано от Microsoft подробно. Двоичният DDS файл съдържа следната информация.
...
[Ръководството за програмиране на DDS файлов формат] (https://docs.microsoft.com/en-us/windows/win32/direct3ddds/dx-graphics-dds-pguide) допълнително разработва техническите подробности за този файлов формат.
