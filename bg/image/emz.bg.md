...
Файл с разширение .emz е компресиран контейнер на подобрен метафайл ([EMF](/bg/image/emf/) файл). Те се компресират с помощта на техниката за компресиране [GZIP](/bg/compression/gz/), която е често използваният метод за компресиране в операционните системи UNIX и LINUX. Премахнете връзката с ZIP (/bg/compression/zip/), GZIP компресира архива като цяло, вместо да компресира отделни файлове. EMZ файловете са с по-малък размер в сравнение с EMF файловете и помагат за бързо прехвърляне по време на онлайн споделяне на файлове. Някои от приложенията, които могат да отварят EMZ файлове, включват Microsoft Visio 2019, Microsoft Office 2019, XnView MP и File Viewer Plus.
