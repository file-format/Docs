...
* **Компресия със загуби:** Компресията със загуби се основава на [VP8](http://en.wikipedia.org/wiki/VP8) кодиране на ключови кадри. VP8 е формат за видео компресия, създаден от On2 Technologies като наследник на форматите VP6 и VP7.
