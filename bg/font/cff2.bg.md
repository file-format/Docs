...
[Спецификациите на файловия формат CFF2] (https://docs.microsoft.com/en-us/typography/opentype/spec/cff2) съдържат подробности за вътрешното оформление на данните, типовете данни, таблиците и друга вътрешна информация за файловия формат. Може да бъде препоръчан за справка на разработчика. Някои от подробностите за тях са както следва.
...
* [Файлов формат CFF2](https://docs.microsoft.com/en-us/typography/opentype/spec/cff2)
