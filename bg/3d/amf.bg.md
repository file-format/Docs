...
Следва пример за AMF файл, който може да бъде копиран в [текст](/bg/текстообработка/txt/) файл и записан като компресиран [zip](/bg/компресия/zip/) файл за отваряне.
```
