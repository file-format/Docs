...
WUD файловете се записват на диск в собствен файлов формат и могат да бъдат заредени в Cemu емулатор за емулиране на Wii U приложения на компютър. Поради големия си размер WUD файловете са [компресирани](/bg/компресия/), за да се намали размерът на файла. Полученият компресиран файл е известен като WUX файл.
