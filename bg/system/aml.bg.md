...
AML файловете се записват като двоични файлове на диск със съдържание, записано в байт код. Спецификациите на файловия формат на стандарта ACPI са налични на [uefi](https://uefi.org/node/735). Езикът е проектиран да предлага стабилност и обратна съвместимост, като изисква по-малко презаписване или повторно изграждане на стека на приложението.
