...
PUB файловете се съхраняват като двоични файлове на диск. Съдържанието на PUB файловете може също да бъде преобразувано във файлов формат [DOCX](/bg/текстообработка/docx/) от приложението Microsoft Publisher чрез използване на опцията Запиши като.
