...
Подреден масив от координати представлява [позицията](http://geojson.org/geojson-spec.html#positions). Това е най-малката единица, която може да посочи точка на земята.
