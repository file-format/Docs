{
  "date" : "2019-10-11",
  "keywords" :[ "vsx файл", "vsx файлов формат", "какво е vsx файл", "файл", "vsx пример", "vsx файлово разширение", "разширение", "формат" ],
  "author" : {
    "display_name" : "Kashif Iqbal"
},
  "draft" : "false",
  "toc" : true,
  "title" :"VSX – Microsoft Visio Stencil файлов формат",
  "description":"Научете за файловия формат VSX и API, които могат да създават и отварят VSX файлове.",
  "linktitle" : "VSX",
  "menu" : {
    "docs" : {
...
Файловете с разширение .vsx се отнасят за шаблони, които се състоят от чертежи и форми, които се използват за създаване на диаграми в Microsoft Visio. VSX файловете се записват в XML файлов формат и се поддържаха до Visio 2013. Те са различни от основния [VSDX](/bg/image/vsdx/) файлов формат, който беше въведен с Microsoft Visio 2013. VSX файловете могат да се отварят във всеки текстов редактор за да видите съдържанието. VSX файловете могат да бъдат конвертирани в няколко различни файлови формата като PDF и HTML.

## VSX файлов формат ##

Примерен VSX файл, отворен в XML редактор, е както е показано по-долу. Типичният VSX файл има следните възли, както се наблюдава от неговото XML представяне.

### Свойства на документа ###

Някои от елементите, съдържащи се в раздела Свойства на документа, са както следва:
...
Типичен възел с настройки на документ съдържа следните елементи.
...
Цветовият възел съдържа цветни записи, които да се използват в целия документ.
...
Възелът FaceNames във файла представлява свойствата TypeFace.FaceNames, използвани в документа.
...
Възелът StyleSheets съдържа информация за листовете със стилове, използвани в документа. Всеки стилов лист може да има информация за стилови свойства, линии, шаблони за запълване, текстови блокове и други подобни елементи.

### Лист с документи ###

Възелът DocumentSheet съдържа информация за свойствата на документа и информация за потребителското име и изглежда както следва:
...
Съдържа информация за страниците на документ на Visio, като свойства на страницата, оформления, решетки на линийка, фигури, изображения и други подобни данни.
