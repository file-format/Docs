...
**IFC-ZIP:** Това е [ZIP](/bg/компресия/zip/) компресирана версия на IFC или IFC-XML, където един от тези файлове е основната директория на zip архива. Този формат компресира .ifc с 60-80% и .ifc XML файл с 90-95%.
