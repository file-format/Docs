...
"draft": "false",
"toc": true,
"title": "DXB файлов формат - двоичен обмен на чертежи",
...
DXB (Drawing Exchange Binary) е двоична версия на DXF (Drawing Exchange Format) файлов формат, който е стандартен формат за обмен на CAD чертежи между различни софтуерни приложения.
...
Файлът DXB (Drawing Exchange Binary) съдържа двоични данни, които представляват 2D векторни графики като линии, дъги, кръгове, текст и други геометрични фигури, които съставят CAD чертеж.
...
Тъй като DXB файловете се съхраняват в двоичен формат, те обикновено са по-малки по размер и по-бързи за зареждане от DXF (Drawing Exchange Format) файлове, които се съхраняват в обикновен текст. DXB файловете обаче могат да се четат само от CAD програми, които поддържат DXB формат, докато DXF файловете могат да се четат от по-широк набор от програми.

## Препратки
* [DXB файлов формат](http://web.archive.org/web/20060824054154/https://www.autodesk.com/techpubs/autocad/acadr14/dxf/the_dxb_file_format_al_u05_b.htm)
