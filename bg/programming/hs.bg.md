...
Кодът може да бъде написан в .hs файл и компилиран с помощта на компилатор на Haskell като [GHC](http://haskell.org/ghc). Следният ред от код се записва като „HelloWorld.hs“, както е показано в следния пример.
