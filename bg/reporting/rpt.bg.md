...
### Съвместимост
Резултатът може да бъде експортиран във формати като [XLS](/bg/spreadsheet/xlsx/), [CSV](/bg/spreadsheet/csv/), [PDF](/bg/pdf/), [DOCX](/bg/text-processing/docx /), текст или печат с перфектна като пиксел прецизност на дизайна.
