...
PDF/A-3 включва всички изисквания за съответствие на ниво 2 и позволява вграждане на допълнителни файлови формати (като XML, [CSV](/bg/spreadsheet/csv/), [CAD](/bg/cad/), [текстообработка](/bg/word-processing/), [електронна таблица](/bg/spreadsheet/) и други) в документите, отговарящи на PDF/A.
