...
Пакетът е [ZIP](/bg/compression/zip/) архив, който съдържа множество части и отговаря на конвенциите за отворено опаковане, посочени в [ISO/IEC-29500-2](https://go.microsoft.com/fwlink/ ?LinkId=150883). ACCDT файловете трябва да съдържат поне една част от метаданата на шаблона, която трябва да бъде целта на връзката. Тези метаданни на шаблона са началната част на ACCDT файл.
