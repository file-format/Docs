...
* [Ръководство за архитектура и управление на регистъра на транзакциите](https://docs.microsoft.com/en-us/sql/relational-databases/sql-server-transaction-log-architecture-and-management-guide?view=sql- сървър-ver15)
