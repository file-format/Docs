...
PZZ файлът, генериран от Poser, е компресиран файлов формат с малък размер за прехвърляне през интернет и други медии. Poser също запазва файла на сцената в некомпресирана форма с **.PZ3 разширения**, които можете да компресирате сами в **ZIP** или **RAR**, ако е необходимо. Bondware придоби Poser от Smith Micro през юни 2019 г.

## Как да отворя PZZ файл?
