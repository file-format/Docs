...
WHL файловият формат е [ZIP](/bg/компресия/zip/) (.zip) архив, който съдържа всички инсталационни файлове и метаданни, изисквани от инсталаторите за инсталиране на пакет. Тези WHL файлове могат да бъдат извлечени с помощта на опция за разархивиране или стандартни софтуерни приложения за декомпресия като WinZIP и WinRAR.
