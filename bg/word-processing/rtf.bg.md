...
Въведен и документиран от Microsoft, Rich Text Format (**RTF**) представлява метод за кодиране на форматиран текст и графики за използване в приложения. Форматът улеснява междуплатформения обмен на документи с други продукти на Microsoft, като по този начин обслужва целта на оперативната съвместимост. Тази способност го прави стандарт за пренос на данни между софтуер за текстообработка и следователно съдържанието може да се прехвърля от една операционна система в друга, без да се губи форматирането на документа. Спецификациите на файловия формат са достъпни от Microsoft за публично [изтегляне](https://www.microsoft.com/en-us/download/details.aspx?id#10725) и могат да бъдат използвани от гледна точка на програмиста.
...
* [RTF 1.9.1 Спецификации](https://www.microsoft.com/en-us/download/details.aspx?id#10725)
