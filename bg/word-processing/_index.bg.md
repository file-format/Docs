...
Обичайните файлови разширения за обикновен текст и свързаните файлови формати включват **[TXT](/bg/word-processing/txt/)**, **[CSV](/bg/spreadsheet/csv/)**, докато файловите разширения за документи с форматиран текст включват **[DOCX](/bg/text-processing/docx/)**, **[DOC](/bg/text-processing/doc/)** и **[RTF](/bg/text-processing/rtf/)** .

Имате запитвания, свързани с текстови файлови формати? Насочете се към [форумите] на нашата общност (https://forum.fileformat.com/c/word-processing), за да се възползвате от знанията, споделени от експерти по файлови формати.
