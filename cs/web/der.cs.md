{
  ...
  "draft" : "false",
  "toc" : true,
  "title" :"Soubor DER - Formát souboru certifikátu DER",
  "description":"Další informace o formátu souboru DER a rozhraních API, která mohou vytvářet a otevírat soubory DER.",
  "linktitle" : "DER",
  "menu" : {
    "docs" : {
      "identifier":"web-der",
...
Soubory DER se ukládají na disk v binárním formátu souboru, který není čitelný pro člověka. Tyto soubory certifikátů jsou načteny a rozpoznány standardními webovými prohlížeči pro bezpečnou navigaci.

### Jak vypadá certifikát s kódováním DER?

Příklad certifikátu SSL/TLS s kódováním DER je uveden níže.
...
## Převeďte certifikát kódovaný DER na PEM

Soubor certifikátu s kódováním DER lze převést na PEM pomocí následujícího příkazu.
...
* [Získejte digitální certifikát a vytvořte digitální podpis
