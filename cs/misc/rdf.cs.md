{
  ...
  "draft" : "false",
  "toc" : true,
  "title" : "RDF File – Resource Description Framework File – Co je soubor .rdf a jak jej otevřít?",
  "description":"Přečtěte si o RDF Resource Description Framework File a jak jej otevřít.",
  "linktitle" : "RDF",
  "menu" : {
    "docs" : {
      "identifier": "misc-cs-rdf",
      "parent" : "misc"
    }
  },
  "lastmod" : "2024-01-10"
...
2. **Nástroje specifické pro RDF:** Existují speciální programy navržené pro snazší práci se soubory RDF. Mohou mít funkce, jako je barevné kódování různých částí dat RDF, což usnadňuje jejich čtení. Příklady zahrnují Protégé, TopBraid Composer a RDF-Gravity.
