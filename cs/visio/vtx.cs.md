{
  "date" : "2019-10-11",
  "keywords" :[ "soubor vtx", "formát souboru vtx", "co je soubor vtx", "soubor", "příklad vtx", "přípona souboru vtx", "přípona", "formát" ],
  "author" : {
    "display_name" : "Kashif Iqbal"
},
  "draft" : "false",
  "toc" : true,
  "title" :"VTX - Formát souboru šablony výkresu Microsoft Visio",
  "description":"Další informace o formátu souboru VTX a rozhraních API, která mohou vytvářet a otevírat soubory VTX.",
  "linktitle" : "VTX",
  "menu" : {
    "docs" : {
