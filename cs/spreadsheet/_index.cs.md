{
  "date" : "2019-12-10",
  "keywords" :[ "Formáty tabulkových souborů", "XLSX", "XLS", "CSV" ],
  "author" : {
    "display_name" : "Kashif Iqbal"
},
  "draft" : "false",
  "description" :"Tabulkové soubory obsahují data v řádcích a sloupcích a lze je otevřít v tabulkových aplikacích. Formáty tabulkových souborů zahrnují XLSX, XLS, CSV, XLSB, XLSM, XLT, XLTX a další.",
  "categories" :[ "základy" ],
  "title" :"Další informace o souborech tabulkových procesorů a rozhraních API pro otevírání a vytváření souborů tabulkových procesorů",
  "linktitle" : "Formáty tabulkových souborů",
  "menu" : {
    "docs" : {
      "parent" : "spreadsheet",
      "weight" : "01"
...
Následuje seznam běžných tabulkových formátů souborů spolu s jejich příponami.
