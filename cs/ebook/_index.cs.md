{
  ...
  "draft" : "false",
  "categories" :[ "základy" ],
  "description" :"Soubory elektronických knih jsou elektronické soubory, které lze otevřít a číst na digitálních zařízeních známých jako eReaders. Mezi běžné přípony souborů elektronických knih a jejich formáty souborů patří EPUB, FB2 a Mobi.",
  "title" :"Další informace o formátech souborů elektronických knih a rozhraních API, která mohou otevírat a vytvářet soubory elektronických knih",
  "linktitle" : "Formáty souborů elektronických knih",
  "menu" : {
    "docs" : {
      "parent" : "ebook",
      "weight" : "01"
...
Následuje seznam běžných formátů souborů EBook spolu s jejich příponami.
