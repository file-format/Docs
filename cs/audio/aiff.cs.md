...
AIFF a WAV jsou z hlediska kvality téměř stejné. Oba používají stejné kódování PCM (pulse-code modulation), což je činí většími ve srovnání s jinými ztrátovými formáty, jako je [MP3](https://docs.fileformat.com/audio/mp3/), [M4A](). Některé z obecných rozdílů jsou uvedeny v tabulce níže:
