...
ملف ASC هو ملف ** نصي ** تم إنشاؤه بلغة برمجة أكشن سكريبت. يحتوي على رمز يتم تشغيله على جانب الخادم برنامج استضافة Flash Media Server. يحتوي ملف ASC على نصوص برمجية تُستخدم للتحكم في أحداث التطبيق مثل تحميل تطبيقات Flash ، والتعامل مع إجراءات المستخدم من أحداث الماوس ولوحة المفاتيح ، وتشغيل محتوى الوسائط المتعددة وتقديم إخراج التطبيق. استحوذت Adobe على Macromedia Flash الذي أصبح لاحقًا جزءًا من دعوى Adobe Creativity باسم Adobe Flash. يتم استخدامه لحفظ ملفات الرسوم المتحركة في [تنسيق ملف .swf] (صفحة وصف اللغة / swf /).
...
* [تنسيق ملف .swf] (صفحة وصف اللغة / swf /)
