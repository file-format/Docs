...
يسمح ملف AIDL (لغة تعريف واجهة Android) لمطوري Android بإنشاء اتصال بين التطبيقات المختلفة. بناءً على واجهة البرمجة ، يوافق كل من العميل والخدمة على التواصل باستخدام الاتصال بين العمليات (IPC). يحتوي ملف AIDL على كود مصدر [Java](/ar/programming/java/) لتحديد هذه الواجهات وعقود الاتصال بين التطبيقات.
