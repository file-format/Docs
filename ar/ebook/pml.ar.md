...
قدمت شركة Palm Inc تنسيق ملف PML الذي يرمز إلى Palm Markup Language File. والغرض منه هو إنشاء مستندات للقارئ الإلكتروني وهو جهاز قراءة كتاب إلكتروني مشابه للكمبيوتر اللوحي. يعطي ملف PML التخطيط لملف [PDB](/ar/programming/pdb/) (يحتوي على ملفات بيانات مختلفة) ليتم عرضها على جهاز Palm.
