...
الملف بامتداد .drawio هو ملف رسم تم إنشاؤه باستخدام draw.io الخاص بـ [https://www.diagrams.net/) وهو برنامج مفتوح المصدر للعمل مع الرسوم البيانية. يحتوي على معلومات شاملة عن المحتوى وتنسيق عناصر الرسم التخطيطي مثل النص والصور والتخطيط والأشكال وتحديد المواقع. تشتمل المخططات التي يدعمها DRAWIO على مخططات انسيابية ومخططات تنظيمية وخرائط وعناصر هندسية ومخططات عملية ومخططات والمزيد. يمكن تصدير ملفات DRAWIO إلى عدة تنسيقات مختلفة مثل [JPG](/ar/image/jpeg/) ، [PNG](/ar/image/png/) ، [BMP](/ar/image/bmp/) ، [XML](/ar/web/xml/) و PDF و [HTML](/ar/web/html/) و [VSDX](/ar/visio/vsdx/).
