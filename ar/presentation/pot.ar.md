...
لا تتوفر مواصفات تنسيق الملف لتنسيق ملف POT بشكل فردي بواسطة Microsoft. ومع ذلك ، فإن تنسيق القالب هو نفسه تنسيق الملف الثنائي [PPT](/ar/presentation/ppt/) ويمكن فتحه في MS PowerPoint لغرض التحرير. يتم تحديد ملف POT بواسطة معرف HEX على النحو التالي:
