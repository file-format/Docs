...
OAR هي ملفات ثنائية يتم تخزينها في تنسيق ملف أرشيف مضغوط. أحدث إصدار من تنسيق ملف OAR هو [الإصدار 1.0](http://opensimulator.org/wiki/OAR_Format_1.0) الذي يحتوي على تغييرات كبيرة عن [الإصدار 0.8](http://opensimulator.org/wiki/OAR_Format_0.8) السابق . يدعم الإصدار الأخير تخزين مناطق متعددة في OAR واحد ولا يتوافق مع الإصدارات السابقة مع إصدارات OpenSimulator قبل 0.7.5. ملف OAR هو ملف gzipped tar (tar.gz) بتنسيق unix tar الأصلي (وليس USTAR).
