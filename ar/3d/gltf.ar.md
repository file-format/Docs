...
تتوفر مواصفات تنسيق الملف لـ glTF 2.0 [عبر الإنترنت](https://github.com/KhronosGroup/glTF/tree/main/specification/2.0) كمرجع ويجب الرجوع إليها في أي تنفيذ متعلق بالقراءة / الكتابة لدعم تنسيق ملف glTF.
...
** مسارات URI النسبية: ** أو مسار noscheme كما هو محدد بواسطة RFC 3986 ، [القسم 4.2](https://datatracker.ietf.org/doc/html/rfc3986#section-4.2) - بدون مخطط أو سلطة أو معلمات. يجب أن تكون الأحرف المحجوزة مشفرة بالنسبة المئوية ، وفقًا لـ RFC 3986 ، [القسم 2.2](https://datatracker.ietf.org/doc/html/rfc3986#section-2.2).
