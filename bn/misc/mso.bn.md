...
## মাইক্রোসফট এমএসও ফাইল ফরম্যাট

MSO ফাইলগুলি মাইক্রোসফ্ট কম্পাউন্ড ডকুমেন্ট ফাইল ফরম্যাটে (MCDF) সংরক্ষিত হয় যা অবজেক্ট লিঙ্কিং অ্যান্ড এমবেডিং (OLE) বা কম্পোনেন্ট অবজেক্ট মডেল (COM) স্ট্রাকচার্ড স্টোরেজ কম্পাউন্ড ফাইল বাস্তবায়ন বাইনারি ফাইল ফর্ম্যাট নামেও পরিচিত।

### MSO ফাইল ফরম্যাট স্ট্রাকচার
...
* [COM স্ট্রাকচার্ড স্টোরেজ](https://en.wikipedia.org/wiki/COM_Structured_Storage)
