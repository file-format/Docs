...
{{< figure src="../odf.png" alt="ODF ফাইল ফরম্যাট" >}}
...
* [ODF - উইকিপিডিয়া](https://en.wikipedia.org/wiki/OpenDocument)

* [Apache OpenOffice Math ব্যবহার করা](https://wiki.openoffice.org/wiki/Documentation/OOo3_User_Guides/Math_Guide)
