{
  "date" : "2021-08-30",
  "keywords" :[ "GO", "file", "extension", "file format", "Gо рrоgrаmming language", "Programming Guide", "go example", "Google Go", "Gоlаng" ],
  "author" : {
...
* [GO - von Wikipedia](https://en.wikipedia.org/wiki/Go_(programming_language))
