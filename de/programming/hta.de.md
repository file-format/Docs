{
  "date" : "2021-09-16", 
  "keywords" :[ "hta", "Datei", "Erweiterung", "Dateiformat", "hta-Implementierung", "Programmierhandbuch", "hta-Beispiel", "HTML-Anwendung", "Hypertext Markup Language-Anwendung", "HTA-Dateien", "Microsoft HTML-Anwendung"],
  "author" : {
...
HTMLA steht für **Hypertext Markup Language Application** und ist ein Programm, das mit Microsoft Windows kompatibel ist. Der Quellcode dieses Programms enthält mehr als eine Skriptsprache wie [HTML](/de/web/html/) und [JavaScript](/de/web/js/). Für die Benutzeroberfläche wird eine HTML-Anwendung bevorzugt, während zur Erfüllung der Anforderung an die Programmlogik jede andere Skriptsprache verwendet wird.
...
* [HTA - von Wikipedia](https://en.wikipedia.org/wiki/HTML_Application)
