{
  "date" : "2019-10-11",
  "keywords" :[ "vsx-Datei", "vsx-Dateiformat", "was ist eine vsx-Datei", "Datei", "vsx-Beispiel", "vsx-Dateierweiterung", "Erweiterung", "Format" ],
  "author" : {
    "display_name" : "Kashif Iqbal"
},
  "draft" : "false",
  "toc" : true,
  "title" :"VSX - Microsoft Visio-Schablonendateiformat",
  "description":"Erfahren Sie mehr über das VSX-Dateiformat und APIs, die VSX-Dateien erstellen und öffnen können.",
  "linktitle" : "VSX",
  "menu" : {
    "docs" : {
...
Eine im XML-Editor geöffnete Beispiel-VSX-Datei ist unten abgebildet. Eine typische VSX-Datei hat die folgenden Knoten, wie aus ihrer XML-Darstellung hervorgeht.

### Dokumenteigenschaften ###

Einige der im Abschnitt Dokumenteigenschaften enthaltenen Elemente lauten wie folgt:
...
Ein typischer Dokumenteinstellungsknoten enthält die folgenden Elemente.
...
Der Farbknoten enthält Farbeinträge, die im gesamten Dokument verwendet werden sollen.
...
Der FaceNames-Knoten in der Datei stellt TypeFace.FaceNames-Eigenschaften dar, die im Dokument verwendet werden.
...
Der StyleSheets-Knoten enthält Informationen zu den im Dokument verwendeten Stylesheets. Jedes Stylesheet kann Informationen über Stileigenschaften, Linien, Füllmuster, Textblöcke und andere derartige Elemente enthalten.

### Dokumentenblatt ###

Der DocumentSheet-Knoten enthält Informationen zu den Dokumenteigenschaften und Informationen zum Benutzernamen und sieht wie folgt aus:
...
Enthält Informationen zu den Seiten eines Visio-Dokuments wie Seiteneigenschaften, Layouts, Linealraster, Formen, Bilder und andere ähnliche Daten.
