{
  "date" : "2019-10-11",
  "keywords" :[ "vrml-Datei", "vrml-Dateiformat", "was ist eine vrml-Datei", "Datei", "vrml-Beispiel", "vrml-Dateierweiterung", "Erweiterung", "Format" ],
  "author" : {
...
Die Virtual Reality Modeling Language (VRML) ist ein Dateiformat zur Darstellung interaktiver [3D](/de/3d/)-Weltobjekte über das World Wide Web (www). Es findet seine Verwendung bei der Erstellung dreidimensionaler Darstellungen komplexer Szenen wie Illustrationen, Definitionen und Virtual-Reality-Präsentationen. Das Format wurde durch [X3D](/de/3d/x3d/) ersetzt. Viele 3D-Modellierungsanwendungen können Objekte und Szenen im VRML-Format speichern.
