{
  "date" : "2021-02-26",
  "keywords" :[ "OPUS", "Datei", "Erweiterung", "Format", "Audiokodierung"],
  "author" : {
    "display_name" : "Sami Cheema"
},
  "draft" : "false",
  "toc" : true,
  "description" :"Erfahren Sie mehr über das OPUS-Dateiformat und APIs, die OPUS-Dateien erstellen und öffnen können.",
  "title" :"OPUS",
  "linktitle" :"OPUS",
  "menu" : {
    "docs" : {
...
* [OPUS - Von Wikipedia](https://en.wikipedia.org/wiki/Opus_(audio_format))
