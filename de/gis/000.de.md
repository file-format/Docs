...
Eine einzelne S-57-Datei kann mehr als 100 Ebenen enthalten. Features in einer S-57-Datei werden basierend auf dem Namen der Objektklasse (OBJL) einem Layer zugewiesen. Jeder Feature-Typ in einer S-57-Datei hat einen vordefinierten Satz von Attributen, wie durch den S-57-Standard definiert. Dies sind Kurznamen, die mithilfe des S-57-Objekt-/Attributkatalogs mit längeren, aussagekräftigeren Namen in Beziehung gesetzt werden können.
