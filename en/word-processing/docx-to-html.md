...
1. Use the code sample in [Convert DOCX to HTML](https://docs.aspose.com/words/net/convert-a-document-to-html-mhtml-or-epub/) article to try it in your application
 ...
 * Convert DOCX to HTML in Java - [DOCX to HTML Conversion guide](https://docs.aspose.com/words/java/convert-a-document-to-html-mhtml-or-epub/)
...
**Aspose.Words for C++ Resources**
 ...
 1. Convert DOCX to HTML in C++ - [DOCX to HTML Conversion guide in C++](https://docs.aspose.com/words/cpp/convert-a-document-to-html-mhtml-or-epub/)
...
1. Convert DOCX to HTML using Python via .NET - [DOCX to HTML Conversion guide in Python via .NET](https://docs.aspose.com/words/python-net/convert-a-document-to-html-mhtml-or-epub/)
