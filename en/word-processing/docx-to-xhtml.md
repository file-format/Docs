...
There are several online tools available online that are used for conversion of [DOCX](/word-processing/) to [XHTML](/web/xhtml/). One such app is Aspose.Words app that lets you load DOCX files and convert it to several different file formats including XHTML.
...
1. Go to [Aspose.Words conversion app](https://products.aspose.app/words/conversion/docx-to-xhtml)
1. Upload your DOCX file to the browser
1. Select XHTML as output file format
...
1. Use the code sample in [Convert DOCX to XHTML](https://docs.aspose.com/words/net/convert-a-document-to-html-mhtml-or-epub/) article to try it in your application
 ...
 * Convert DOCX to XHTML in Java - [DOCX to XHTML Conversion guide](https://docs.aspose.com/words/java/convert-a-document-to-html-mhtml-or-epub/)
...
**Aspose.Words for C++ Resources**
 ...
 1. Convert DOCX to XHTML in C++ - [DOCX to XHTML Conversion guide in C++](https://docs.aspose.com/words/cpp/convert-a-document-to-html-mhtml-or-epub/)
...
1. Convert DOCX to XHTML using Python via .NET - [DOCX to XHTML Conversion guide in Python via .NET](https://docs.aspose.com/words/python-net/convert-a-document-to-html-mhtml-or-epub/)
