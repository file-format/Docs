...
A file with .DC3 extension is a 3D drawing created with DesignCAD 3D MAX which is a CAD software. It is used to create high-quality designs, simple renders and animations and supports import/export of [STL](/cad/stl/). A DC3 file is used as an alternative to the .DCD file format.
