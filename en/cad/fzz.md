{
   ...
   "draft":"false",
   "toc":true,
   "title":"FZZ File - Fritzing Shareable Project - What is an .fzz file and how to open it?",
   "description":"Learn about FZZ Fritzing Shareable Project file format and APIs that can create and open FZZ files.",
   "linktitle":"FZZ",
   "menu":{
      "docs":{
         "identifier":"cad-fzz",
