...
#### Index table
The index table contains several 4-byte entries, which indicate the position of each data block and an additional, last entry which points to the end of file.
