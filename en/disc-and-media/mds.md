{
  ...
  "draft" : "false",
  "toc" : true,
  "description" : "Learn about MDS file format and APIs that can create and open MDS files.",
  "title" : "MDS File Format - Media Descriptor Sidecar File",
  "linktitle" : "MDS",
  "menu" : {
    "docs" : {
...
3. Navigate to the location of the MDS file on your computer and select it.
4. The MDS file will now be opened in Alcohol 120%, and you will be prompted to select the corresponding image file ( such as ISO, BIN or CUE ).
5. After you select the image file, Alcohol 120% will mount the image to a virtual drive.
...
## References
* [Alcohol 120% - CD and DVD burning software](https://www.alcohol-soft.com/)
