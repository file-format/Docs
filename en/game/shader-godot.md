...
4.  Distorting or animating appearance of objects.
...
1.  **Open Source:** Godot is released under MIT license, which means it is free to use and open source. Developers can access and modify source code, making it highly customizable.
...
3.  **Scripting:** Godot supports multiple scripting languages, including GDScript (a Python-like language designed for Godot), C# and VisualScript (a visual programming language). This flexibility allows developers to choose language they are most comfortable with.
...
7.  **Asset Management:** Godot offers a resource system for managing assets, including images, audio, 3D models and more. Resources are easily imported and organized in engine.
