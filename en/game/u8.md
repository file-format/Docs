...
U8 files are archive files that are compressed using the YAZ0 file to make the file size smaller. [U8 file system](http://wiki.tockdom.com/wiki/U8_(File_Format)) consists of a list of nodes with each node comprising of 12 bytes as shown below.
 ...
 * [Mario Kit Wii U8 File Format](http://wiki.tockdom.com/wiki/U8_(File_Format))
