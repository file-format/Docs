...
DEM files are commonly available on the internet and samples can be downloaded for use. The [United States Geological Survey](https://www.usgs.gov/) (USGS) provides many DEM files at their web site.

## References

* [DEM Files](https://en.wikipedia.org/wiki/Digital_elevation_model)
