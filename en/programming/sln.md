...
**Solution:** A solution contains one or more projects. So the solution is just like a container for Visual Studio project. Logically, we can say someone wants to get a complete solution for his business including a website, desktop app, restful service and mobile app.
