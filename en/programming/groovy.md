{
  ...
  "draft": "false",
  "toc": true,
  "title": "GROOVY File Format",
  "description": "Learn about GROOVY file format and APIs that can create and open GROOVY files.",
  "linktitle": "GROOVY",
  "menu": {
    "docs": {
      "parent": "programming",
      "identifier": "programming-groovy"
    }
  },
  "lastmod": "2022-04-06"
}
...
A GROOVY file is a source code file written in the Groovy programming language. Code written inside a GROOVY file is similar to the object-oriented language [Java](/programming/java/), that makes it easy for design and development of applications. A GROOVY file is compiled to Java virtual machine (JVM) bytecode and is compatible with other Java code and libraries.
...
* [APACHE GROOVY - by Wikipedia](https://en.wikipedia.org/wiki/Apache_Groovy)
