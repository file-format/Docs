...
An AS3PROJ file is saved in [XML](/web/xml/) file format that is a universal file format for exchange of information. It can be opened in any text editor such as Notepad, Notepad++ and Atom to examine the contents.
