...
ASC files are saved as text files that can be opened and edited with [Adobe Media Encoder](https://www.adobe.com/products/media-encoder.html). These are created and saved as text files and can be opened with any text editor such as Microsoft Notepad, Notepad++ and Apple TextEdit. The ASC file is executed by default when Flash Media Server runs and application.
