...
## AWS File Format - More Information

AWS files are stored to disc as binary files. However, its file format specifications are not available publicly for developer's reference. 
