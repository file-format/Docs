...
The content type for this format is:
...
SXC files are compatible with Apache Open Office calc and data can be exported to Microsoft excel file using the following method:
