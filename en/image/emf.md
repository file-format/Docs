...
The diagram below depicts the three versions of an EMF metafiles,

![EMF File Format](/image/emf/1544206297467-320.png "EMF File Format")
...
![EMF Record](/image/emf/image-20181207182250-1.png "EMF Record")
...
* __[Enhanced-Format Metafiles | Microsoft Docs](https://docs.microsoft.com/en-us/windows/desktop/gdi/enhanced-format-metafiles)__
* (((

__[Enhanced Metafile Format and Specification](https://msdn.microsoft.com/en-us/library/cc230514.aspx)__
)))