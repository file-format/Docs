{
   ...
   "draft":"false",
   "toc":true,
   "title":"INK File - Pantone Reference - What is an .ink file and how to open it?",
   "description":"Learn about INK Pantone Reference file format and APIs that can create and open INK files.",
   "linktitle":"INK",
   "menu":{
      "docs":{
