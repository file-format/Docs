{
  ...
  "description":"Learn about CRX file format and APIs that can create and open CRX files.",
  "linktitle" : "CRX",
  "menu" : {
    "docs" : {
      "parent" : "plugin",
      "identifier":"plugin-en-crx"
    }
  },
  "lastmod" : "2023-11-28"
}
...
In order to open a CRX file:
 ...
 1. Go to the extensions menu in Google Chrome browser
 1. Drag and drop the CRX file to the extension page of the browser
 1. Click `Add Extension` when prompted
