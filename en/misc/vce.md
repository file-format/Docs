{
   ...
   "draft":"false",
   "toc":true,
   "title":"VCE File - Visual CertExam - What is a .vce file and how to open it?",
   "description":"Learn about VCE Visual CertExam Exam file format and APIs that can create and open VCE files.",
   "linktitle":"VCE",
   "menu":{
      "docs":{
         "identifier":"misc-vce",
