{
   ...
   "draft":"false",
   "toc":true,
   "title":"INK File - Mimio Notebook - What is an .ink file and how to open it?",
   "description":"Learn about INK Mimio Notebook file format and APIs that can create and open INK files.",
   "linktitle":"INK",
   "menu":{
      "docs":{
         "identifier":"misc-ink",
