{
   ...
   "draft":"false",
   "toc":true,
   "title":"TGC File - Terragen Node Clip - What is a .tgc file and how to open it?",
   "description":"Learn about TGC Terragen Node Clip file format and APIs that can create and open INK files.",
   "linktitle":"TGC",
   "menu":{
      "docs":{
         "identifier":"data-tgc",
