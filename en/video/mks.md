...
### Images Subtitles
The VobSub subtitle format is the first image subtitle format to import into Matroska. This format is generated by exporting the subtitles from a DVD. The tracks should be separated while storing in Matroska, if the VobSub consist of a set of multiple streams.
