...
3G2(3GPP2 file format) is a multimedia container format similar to the [3GP](/video/3gp) file format. 3G2 is defined by the Third Generation Partnership Project 2 (3GPP2) for 3G CDMA2000 multimedia services. 3G2 files are stored with the .3g2 extension. As compared to 3GP files, 3G2 files consume less space and bandwidth.
