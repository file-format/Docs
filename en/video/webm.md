...
|EBMLVersion |The version of the EBML parser used to create the file.|
...
|EBMLMaxSizeLength|The maximum length of the sizes you'll find in this file (8 or less in Matroska). This does not override the element size indicated at the beginning of an element. Elements that have an indicated size that is larger than what is allowed by EBMLMaxSizeLength shall be considered invalid.|
...
---|---|
|SeekHead |Contains the position of another level 1 element.|
