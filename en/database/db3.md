...
## DB3 File Format
The DB3 file format is associated with RDBMS (Relational Database Management System) SQLite, a popular choice for embedded database. There is no any specific file extension defined in an SQLite_3  in its specification, it may use extensions including [.db](/database/db),[.sqlite](/database/sqlite). 
