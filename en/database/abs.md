...
ABS files are strored as part of the application's [EXE file](/executable/exe/) which is usually stored as a binary file. Binary files can not be opened in any text editor and provide fast access to the contents of the database file.
