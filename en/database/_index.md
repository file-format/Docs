{
  ...
  "description" : "Database files are used for digital storage of data on computers and contain entries as records that are often managed by DBMS.",
  "title" : "Learn about Database File Formats and APIs that can open and create Database files",
