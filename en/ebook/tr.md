...
A file with a .tr extension is TomeRaider eBook file that is created with TomeRaider eReader software. These files can be opened on both Windows and Handheld devices such as Android, Palm OS, and EPOC, and are categorized as text files. The TomeRaider software developed by [Yadabyte](https://www.yottabyte.ltd/) website and the official website provides more information about the TR files. The TR2 file format was replaced by the TR3 (TomeRaider 3) format. TR files offer fast searching and high compression levels.

## Brief History of TR File Format
