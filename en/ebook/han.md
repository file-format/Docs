 ...
 *	If the above-mentioned program is not helping to open the file, then its time to check the file type to make sure you have a program that can open that type of file
