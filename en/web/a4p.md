...
A4P files are created from template files and saved as binary files to disc. The internal file format structure of A4P files is not known.

A4P files can be opened with **Avanquest A4Desk Pro** software.
