...
Fișierele U8 sunt fișiere de arhivă care sunt comprimate folosind fișierul YAZ0 pentru a micșora dimensiunea fișierului. [Sistemul de fișiere U8](http://wiki.tockdom.com/wiki/U8_(File_Format)) constă dintr-o listă de noduri, fiecare nod cuprinzând 12 octeți, așa cum se arată mai jos.
...
* [Format de fișier Mario Kit Wii U8](http://wiki.tockdom.com/wiki/U8_(File_Format))
