{
  ...
  "draft" : "false",
  "toc" : true,
  "title" :"DER File - DER Certificate File Format",
  "description":"Aflați despre formatul de fișier DER și despre API-urile care pot crea și deschide fișiere DER.",
  "linktitle" : "DER",
  "menu" : {
    "docs" : {
      "identifier":"web-der",
...
Fișierele DER sunt stocate pe disc în format de fișier binar care nu poate fi citit de om. Aceste fișiere de certificate sunt încărcate și recunoscute de browserele web standard pentru o navigare sigură.

### Cum arată un certificat codificat DER?

Un exemplu de certificat SSL/TLS codificat DER este prezentat mai jos.
...
## Convertiți certificatul codificat DER în PEM

Un fișier de certificat codificat DER poate fi convertit în PEM utilizând următoarea comandă.
...
* [Obțineți un certificat digital și creați o semnătură digitală
