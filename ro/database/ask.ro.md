{
  "date" : "2021-09-06",
  "keywords" :[ "întreaba", "extensie", "fișier", "format fișier", "Tipul fișierului bazei de date", "Format fișierului bazei de date", "askSam Database"],
  "author" : {
    "display_name" : "Kashif Iqbal"
},
  "draft" : "false",
  "toc" : true,
  "description" :"Aflați despre formatul de fișier ASK și despre API-urile care pot crea și deschide fișiere ASK.",
...
Fișierele ASK sunt salvate pe disc în format de fișier binar proprietar ale cărui detalii interne ale formatului de fișier nu sunt disponibile pentru referință de către dezvoltatori.
