...
Un fișier XSD simplu având o schemă de comandă definește elementele folosind etichete, așa cum se arată în următorul [exemplu XSD de la Microsoft](https://docs.microsoft.com/en-us/visualstudio/xml-tools/sample-xsd-file -simple-schema?view=vs-2022).
...
- [Exemplu de exemplu XSD](https://docs.microsoft.com/en-us/visualstudio/xml-tools/sample-xsd-file-simple-schema?view=vs-2022)
