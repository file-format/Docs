{
  ...
  "description" :"Fișierele Ebook sunt fișiere electronice care pot fi deschise și citite pe dispozitive digitale cunoscute sub numele de eReaders. Extensiile obișnuite de fișiere pentru cărți electronice și formatele lor de fișiere includ EPUB, FB2 și Mobi.",
  "title" :"Aflați despre formatele de fișiere de cărți electronice și API-urile care pot deschide și crea fișiere de cărți electronice",
  "linktitle" : "Formate de fișiere de cărți electronice",
  "menu" : {
    "docs" : {
      "parent" : "ebook",
      "weight" : "01"
...
Mai jos este o listă de formate comune de fișiere EBook împreună cu extensiile lor de fișiere.
