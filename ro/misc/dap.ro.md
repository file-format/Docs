{
  ...
  "draft" : "false",
  "toc" : true,
  "title" :"Fișier DAP - Descărcați fișierul Accelerator Plus Descărcare în curs",
  "description":"Aflați despre formatul de fișier DAP și despre API-urile care pot crea și deschide fișiere DAP.",
  "linktitle" : "DAP",
  "menu" : {
    "docs" : {
      "identifier":"misc-dap",
