...
Un singur fișier S-57 poate conține mai mult de 100 de straturi. Caracteristicile dintr-un fișier S-57 sunt atribuite unui strat pe baza numelui clasei de obiecte (OBJL). Fiecare tip de caracteristică dintr-un fișier S-57 are un set predefinit de atribute așa cum este definit de standardul S-57. Acestea sunt nume scurte care pot fi legate de nume mai lungi și mai semnificative folosind catalogul de obiecte/atribute S-57.
