{
  "date" : "2020-02-06",
  "keywords" :[ "CAD", "fișier", "format", "Design asistat de calculator", "DXF", "DWG"],
  "author" : {
    "display_name" : "Kashif Iqbal"
},
  "draft" : "false",
  "description" :"Formatele de fișiere CAD sunt reprezentarea digitală a fișierelor de proiectare asistată de computer. În acest scop sunt utilizate diferite formate, cum ar fi DXF, DWG, IFC, STL, PLT și altele.",
  "categories" :[ "fundamente" ],
  "title" :"Aflați despre formatele de fișiere CAD și API-urile care pot deschide și crea fișiere CAD",
  "linktitle" : "Formate de fișiere CAD",
  "menu" : {
    "docs" : {
      "parent" : "cad",
      "weight" : "01"
...
Mai jos este o listă de formate comune de fișiere CAD împreună cu extensiile lor de fișiere.
