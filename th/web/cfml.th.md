...
ไฟล์ที่มีนามสกุล .cfml คือไฟล์ภาษามาร์กอัป ColdFusion ที่ใช้สร้างหน้าเว็บ หมายถึงชุดของกฎที่ใช้กำหนดว่าโปรแกรมเมอร์ ColdFusion จะพัฒนาอย่างไร ColdFusion เป็นภาษาโปรแกรมที่ใช้สร้างเว็บแอปพลิเคชันฝั่งเซิร์ฟเวอร์อย่างรวดเร็วและใช้เทคโนโลยีน้อยกว่าอื่นๆ เช่น [ASP](/th/web/asp/), [PHP](/th/web/php/) เป็นต้น บางภาษา แอปพลิเคชันที่สามารถเปิดไฟล์ CML ได้แก่ Adobe ColdFusion 2018, Adobe ColdFusion Builder และ Adobe Dreamweaver
