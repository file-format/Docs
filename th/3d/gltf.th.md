...
ข้อกำหนดรูปแบบไฟล์สำหรับ glTF 2.0 มีให้ [ออนไลน์](https://github.com/KhronosGroup/glTF/tree/main/specification/2.0) สำหรับการอ้างอิง และควรปรึกษาในการใช้งานที่เกี่ยวข้องกับการอ่าน/การเขียนสำหรับการสนับสนุน รูปแบบไฟล์ glTF
...
**เส้นทาง URI สัมพัทธ์:** หรือเส้นทาง-noscheme ตามที่กำหนดโดย RFC 3986, [ส่วน 4.2](https://datatracker.ietf.org/doc/html/rfc3986#section-4.2) — ไม่มีแบบแผน สิทธิ์ หรือพารามิเตอร์ อักขระที่สงวนไว้ต้องเข้ารหัสเป็นเปอร์เซ็นต์ตาม RFC 3986 [ส่วนที่ 2.2](https://datatracker.ietf.org/doc/html/rfc3986#section-2.2)
