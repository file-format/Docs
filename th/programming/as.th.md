{
  ...
  "keywords" :[ "AS", "ไฟล์", "นามสกุล", "รูปแบบไฟล์", "", "คู่มือการเขียนโปรแกรม", "ตัวอย่าง AS", "Аdоbe Flash", "ActionScript", "Mасrоmediа Flash" ],
  "author" : {
    "display_name" : "Sami Cheema"
},
  "draft" : "false",
  "toc" : true,
  "title" :"AS - รูปแบบไฟล์ ActionScript",
  "description":"เรียนรู้เกี่ยวกับรูปแบบไฟล์ AS และ API ที่สามารถสร้างและเปิดไฟล์ AS ได้",
  "linktitle" : "AS",
  "menu" : {
    "docs" : {
      "parent" : "programming"
