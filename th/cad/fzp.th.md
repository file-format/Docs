...
ไฟล์ FZP เป็นไฟล์ XML ที่มีข้อมูลเกี่ยวกับคุณสมบัติของชิ้นส่วน ตัวเชื่อมต่อ และบัส นอกจากนี้ ไฟล์ FZP ยังมีข้อมูลเกี่ยวกับชื่อ คำอธิบาย ผู้แต่ง และวันที่เผยแพร่ไฟล์ FZP เมื่อส่งออกไฟล์ส่วน Fritzing แอป Fritzing จะสร้างไฟล์เก็บถาวรแบบบีบอัด [FZPZ](/th/compression/fzpz/) ที่มีไฟล์ FZP และไฟล์ [SVG](/th/image/svg/) สี่ไฟล์
