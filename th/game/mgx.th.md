...
รูปแบบไฟล์ภายในของไฟล์ MGX ได้รับการปรับปรุงและพร้อมใช้งานเป็นข้อมูลที่ผ่านการตรวจสอบแล้วบางส่วนใน [Age of Empires 2: The Conquerors — ข้อมูลจำเพาะรูปแบบไฟล์ Savegame](https://github.com/stefan-kolb/aoc-mgx- รูปแบบ). ข้อมูลจำเพาะแสดงรายละเอียดในส่วนต่อไปนี้
