...
รูปแบบไฟล์ **QGZ** เป็นไฟล์เก็บถาวรแบบบีบอัดที่มีไฟล์ [QGS](https://docs.fileformat.com/gis/qgs/) และไฟล์ QGD ในขณะที่ไฟล์ QGD เป็นฐานข้อมูล sqlite ของโครงการ qgis ที่ประกอบด้วยข้อมูลเสริมสำหรับโครงการ หากไม่มีข้อมูลเสริม ไฟล์ QGD จะว่างเปล่า
