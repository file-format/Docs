...
ไฟล์ที่มีนามสกุล .aux เป็นไฟล์เสริมที่มีข้อมูลเชิงพื้นที่สำหรับไฟล์ข้อมูลแรสเตอร์ที่อยู่ในไฟล์ [.JPG](/th/image/jpg/) หรือ GeoTIFF [.TIFF](/th/image/tiff/) เนื่องจากไฟล์แรสเตอร์ไม่สามารถเก็บข้อมูลดังกล่าวได้ ไฟล์ AUX จึงถูกใช้เพื่อจัดเก็บข้อมูลเพิ่มเติมในรูปแบบของข้อมูลที่เกี่ยวข้อง โดยปกติแล้วสิ่งเหล่านี้จะถูกจัดเก็บไว้ในไดเร็กทอรีเดียวกันกับชื่อไฟล์เดียวกันกับชื่อไฟล์แรสเตอร์ที่สอดคล้องกัน โดยทั่วไปไฟล์ AUX จะถูกใช้โดยแอปพลิเคชันเชิงพื้นที่ เช่น ESRI ArcGIS Desktop และ ERDAS IMAGINE
