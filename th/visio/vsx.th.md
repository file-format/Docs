{
  "date" : "2019-10-11",
  "keywords" :[ "ไฟล์ vsx", "รูปแบบไฟล์ vsx", "ไฟล์ vsx คืออะไร", "ไฟล์", "ตัวอย่าง vsx", "นามสกุลไฟล์ vsx","นามสกุล", "รูปแบบ" ],
  "author" : {
    "display_name" : "Kashif Iqbal"
},
  "draft" : "false",
  "toc" : true,
  "title" :"VSX - รูปแบบไฟล์ Microsoft Visio Stencil",
  "description":"เรียนรู้เกี่ยวกับรูปแบบไฟล์ VSX และ API ที่สามารถสร้างและเปิดไฟล์ VSX",
  "linktitle" : "VSX",
  "menu" : {
    "docs" : {
...
ไฟล์ที่มีนามสกุล .vsx หมายถึงสเตนซิลที่ประกอบด้วยภาพวาดและรูปร่างที่ใช้สำหรับสร้างไดอะแกรมใน Microsoft Visio ไฟล์ VSX ถูกบันทึกในรูปแบบไฟล์ XML และรองรับจนถึง Visio 2013 ไฟล์เหล่านี้แตกต่างจากรูปแบบไฟล์ [VSDX](/th/visio/vsdx/) หลักที่นำมาใช้กับ Microsoft Visio 2013 ไฟล์ VSX สามารถเปิดได้ในโปรแกรมแก้ไขข้อความใดๆ เพื่อดูเนื้อหา ไฟล์ VSX สามารถแปลงเป็นรูปแบบไฟล์ต่างๆ เช่น PDF และ HTML

## รูปแบบไฟล์ VSX ##

ตัวอย่างไฟล์ VSX ที่เปิดในโปรแกรมแก้ไข XML มีดังต่อไปนี้ ไฟล์ VSX ทั่วไปมีโหนดต่อไปนี้ตามที่สังเกตจากการแทนค่า XML

### คุณสมบัติเอกสาร ###

องค์ประกอบบางอย่างที่มีอยู่ในส่วนคุณสมบัติของเอกสารมีดังนี้:
...
โหนดการตั้งค่าเอกสารทั่วไปประกอบด้วยองค์ประกอบต่อไปนี้
...
โหนดสีประกอบด้วยรายการสีที่จะใช้ตลอดทั้งเอกสาร
...
โหนด FaceNames ในไฟล์แสดงถึงคุณสมบัติ TypeFace.FaceNames ที่ใช้ในเอกสาร
...
โหนด StyleSheets มีข้อมูลเกี่ยวกับสไตล์ชีตที่ใช้ในเอกสาร แต่ละสไตล์ชีตสามารถมีข้อมูลเกี่ยวกับคุณสมบัติของสไตล์ เส้น รูปแบบการเติม บล็อคข้อความ และองค์ประกอบอื่นๆ

### แผ่นเอกสาร ###

โหนด DocumentSheet ประกอบด้วยข้อมูลเกี่ยวกับคุณสมบัติของเอกสารและข้อมูลชื่อผู้ใช้ และมีลักษณะดังต่อไปนี้:
...
มีข้อมูลเกี่ยวกับหน้าเอกสาร Visio เช่น คุณสมบัติหน้า เค้าโครง เส้นตารางไม้บรรทัด รูปร่าง รูปภาพ และข้อมูลอื่นๆ ที่คล้ายกัน
