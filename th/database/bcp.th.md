...
BCP (รูปแบบสำเนาจำนวนมาก) เป็นรูปแบบข้อมูลทางเทคนิคของ Microsoft SQL Server ที่กำหนดโครงสร้างข้อมูลเพื่อจัดเก็บค่าประเภทข้อมูลฐานข้อมูลที่แตกต่างกันสำหรับการนำเข้า/ส่งออก รูปแบบกำหนดการตีความของแต่ละคอลัมน์ข้อมูลอย่างสมบูรณ์ เพื่อให้สามารถอ่านชุดของค่าที่ระบุในไฟล์ข้อมูลได้ ยูทิลิตี [BCP](https://docs.microsoft.com/en-us/previous-versions/sql/sql-server-2008-r2/ms162802(v=sql.105)) ใช้รูปแบบไฟล์ BCP เพื่ออ่าน ข้อมูลจากไฟล์ดังกล่าวและระบุได้
...
* [รูปแบบ BCP - Microsoft](https://docs.microsoft.com/en-us/openspecs/sql_data_portability/ms-bcp/54965c4d-34c7-400d-b970-1007984315a5)
