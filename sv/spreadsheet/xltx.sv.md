{
  "date" : "2019-12-10",
  "keywords" :[ "XLTX", "fil", "tillägg", "filformat", "Excel Open XML", "Spreadsheet" ],
  "author" : {
    "display_name" : "Kashif Iqbal"
},
  "draft" : "false",
  "toc" : true,
  "description" :"Din filformatguide för att veta vad en XLTX-fil och API:er är som kan skapa och öppna dem.",
  "title" :"Vad är en XLTX-fil?",
  "linktitle" : "XLTX",
  "menu" : {
    "docs" : {
      "parent" : "spreadsheet"
...
Filer med filtillägget .xltx representerar Microsoft Excel-mallfiler som är baserade på Office OpenXML-filformatspecifikationerna. Den används för att skapa en standardmallfil som kan användas för att generera [XLSX](/sv/spreadsheet/xlsx/)-filer som uppvisar samma inställningar som specificeras i XLTX-filen.
...
## Specifikationer för XLTX-filformat

XLTX-filer är baserade på Office OpenXML-filformatet och använder XML och [ZIP](/sv/compression/zip/) för att minska filstorleken. Det skapades med lanseringen av Microsoft Office 2007 för att ersätta det binära XLT-filformatet. I likhet med XLTX kan XLT-filformatet användas för att skapa [XLS](/sv/spreadsheet/xls/)-filer med Microsoft Excel 2003 och 2007. Dessa kan öppnas med Microsoft Excel genom att dubbelklicka på filen. Filorganisationen i ett XLTX-filformat kan observeras genom att döpa om filen till ZIP och sedan extrahera dess innehåll till skiva.
