{
  "date" : "2020-02-06",
  "keywords" :[ "CAD", "fil", "format", "Datorstödd design", "DXF", "DWG" ],
  "author" : {
    "display_name" : "Kashif Iqbal"
},
  "draft" : "false",
  "description" :"CAD-filformat är digital representation av datorstödda designfiler. Olika format används för detta ändamål såsom DXF, DWG, IFC, STL, PLT och andra.",
  "categories" :[ "grundläggande" ],
  "title" :"Läs mer om CAD-filformat och API:er som kan öppna och skapa CAD-filer",
  "linktitle" : "CAD-filformat",
  "menu" : {
    "docs" : {
      "parent" : "cad",
      "weight" : "01"
...
Följande är en lista över vanliga CAD-filformat tillsammans med deras filtillägg.
