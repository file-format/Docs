{
  "date" : "2019-10-11",
  "keywords" :[ "xaml","xaml-fil", "xaml-filformat", "xaml-filtyp", "fil", "typ", "vad är en xaml-fil" ],
  "author" : {
  ...
  "description":"Lär dig om XAML-filformat och API:er som kan skapa och öppna XAML-filer.",
  "linktitle" : "XAML ",
  "menu" : {
    "docs" : {
      "parent" : "web"
...
XAML, Extensible Application Markup Language, tilläggsfiler beskriver användargränssnittselementen för programvaror baserade på Windows Presentation Foundation (WPF). Även om det är ett språk, behöver det inte vara programmerat eftersom det är baserat på standardformatet **[XML](/sv/web/xml/)** som är lätt att använda och förstå. XAML (uttalas som "zammel") utvecklades av Microsoft med specifikt syfte att skapa användargränssnitt. Dess akronym original stod för Extensible Avalon Markup Language, där Avalon var kodnamnet för WPF. XAML-filer sparas ibland med XOML-tillägget också.
