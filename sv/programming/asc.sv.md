{
  ...
  "draft" : "false",
  "toc" : true,
  "title" :"ASC-fil - Adobe ActionScript-filformat",
...
ASC-filer sparas som textfiler som kan öppnas och redigeras med [Adobe Media Encoder](https://www.adobe.com/products/media-encoder.html). Dessa skapas och sparas som textfiler och kan öppnas med vilken textredigerare som helst som Microsoft Notepad, Notepad++ och Apple TextEdit. ASC-filen körs som standard när Flash Media Server körs och applikationen.
