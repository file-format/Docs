{
  ...
  "description" :"E-postfiler är digitala behållare som innehåller text, bilagor, avsändare och mottagares information. Vanliga e-postfilformat inkluderar EML, MSG, EMLX, TNEF, ICS, OFT, PST och OST.",
  "title" :"Läs mer om e-postfilformat och API:er som kan öppna och skapa e-postfiler",
  "linktitle" : "Filformat för e-post",
  "menu" : {
    "docs" : {
      "parent" : "email",
      "weight" : "01"
...
Följande är en lista över populära e-postfiltyper tillsammans med deras tillhörande tillägg.
