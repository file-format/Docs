{
  ...
  "draft" : "false",
  "toc" : true,
  "title" :"קובץ ASC - פורמט קובץ Adobe ActionScript",
...
קובצי ASC נשמרים כקובצי טקסט שניתן לפתוח ולערוך באמצעות [Adobe Media Encoder](https://www.adobe.com/products/media-encoder.html). אלה נוצרים ונשמרים כקובצי טקסט וניתן לפתוח אותם עם כל עורך טקסט כגון Microsoft Notepad, Notepad++ ו-Apple TextEdit. קובץ ASC מופעל כברירת מחדל כאשר Flash Media Server פועל ויישום.
