...
קובץ עם סיומת .pdb הוא קובץ מסד נתונים של תוכנית המכיל מידע איתור באגים עבור קובץ הפעלה מהידור (EXE/DLL). קובצי PDB נוצרים על ידי מהדרים של Microsoft כאשר תוכנית יישום מורכבת במצב ניפוי באגים. הנוכחות של קובץ PDB יכולה לעזור בהנדסה לאחור של קובץ הפעלה מכיוון שהוא מכיל מידע משמעותי על כל הסמלים של המודולים. מסיבה זו קבצים אלה נשמרים בנפרד מקובץ ההפעלה הסופי. [DgbHelp API](https://docs.microsoft.com/en-us/windows/win32/debug/dbghelp-functions) של מיקרוסופט יכול לפתוח קובץ PDB כדי לקבל מידע כגון ציבורים וייצוא, סמלים גלובליים, סמלים מקומיים, סוג נתונים, קבצי מקור ומספרי שורות.
