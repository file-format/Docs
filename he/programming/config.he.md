...
## תבנית קובץ CONFIG
**פורמט הקובץ CONFIG** משמש לתהליכי שרת, יישומי תוכנה והגדרות מערכת הפעלה. מתכנת יכול לכתוב קוד כדי להורות לתוכנה לקרוא את קבצי התצורה שוב ושוב לאחר פרק זמן מסוים ולהחיל את השינויים על התהליך הנוכחי. אין סטנדרטים סופיים או מוסכמות חזקות עבור מערכת הקבצים CONFIG. לדוגמה, קובץ Web.config של מיקרוסופט שייך לפורמט הקובץ CONFIG, המורכב מערכי תגים מבוססי [XML](https://docs.fileformat.com/web/xml/); ניתן לערוך עם Microsoft Visual Studio או כל עורך טקסט אחר.

## דוגמאות לקבצי תצורה:
מכיוון שקובצי התצורה אינם נוצרים על ידי ביצוע כללים, סטנדרטים או מוסכמות, ייתכן שקבצים אלה נכתבו באמצעות פורמטים שונים. קובץ .config עשוי להיות מבוסס על XML, [JSON](https://docs.fileformat.com/web/json/) או כל פורמט אחר. להלן הדוגמאות לקובצי תצורה עבור מערכות הפעלה ותוכנות ידועות:
