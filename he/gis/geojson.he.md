...
מערך מסודר של קואורדינטות מייצג את [המיקום](http://geojson.org/geojson-spec.html#positions). זוהי היחידה הקטנה ביותר שיכולה להצביע על נקודה על פני כדור הארץ.
