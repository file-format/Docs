...
ה-"X" בסיומת הקובץ מתייחס לפורמט הקובץ OpenOffice שהוצג על ידי מיקרוסופט כפורמט קובץ ארכיון [ZIP](/he/compression/zip/) להחלפה של פורמטים בינאריים שנתמכו קודם לכן. קבצי VSTX, לפיכך, מבוססים על פורמט קובץ ה-XML של מפרטי OpenOffice בניגוד לפורמט הקובץ [.VST](/he/visio/vst/) שהוא בפורמט בינארי.
