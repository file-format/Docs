{
  "date" : "2019-10-11",
  "keywords" :[ "קובץ vsx", "פורמט קובץ vsx", "מהו קובץ vsx", "קובץ", "דוגמה vsx", "סיומת קובץ vsx","הרחבה", "פורמט" ],
  "author" : {
    "display_name" : "Kashif Iqbal"
},
  "draft" : "false",
  "toc" : true,
  "title" :"VSX - Microsoft Visio Stencil Format File",
  "description":"למד על פורמט קובץ VSX וממשקי API שיכולים ליצור ולפתוח קובצי VSX.",
  "linktitle" : "VSX",
  "menu" : {
    "docs" : {
...
קבצים עם סיומת .vsx מתייחסים לסטנסילים המורכבים משרטוטים וצורות המשמשים ליצירת דיאגרמות ב- Microsoft Visio. קבצי VSX נשמרים בפורמט קובץ XML ונתמכו עד Visio 2013. אלה שונים מפורמט הקובץ הראשי [VSDX](/he/image/vsdx/) שהוצג עם Microsoft Visio 2013. ניתן לפתוח קבצי VSX בכל עורך טקסט לצפייה בתוכן. ניתן להמיר קבצי VSX למספר פורמטים שונים של קבצים כגון PDF ו-HTML.

## פורמט קובץ VSX ##

קובץ VSX לדוגמה שנפתח בעורך XML הוא כפי שמוצג להלן. לקובץ VSX טיפוסי יש את הצמתים הבאים כפי שנצפו מייצוג ה-XML שלו.

### מאפייני מסמך ###

כמה מהרכיבים הכלולים בסעיף מאפייני מסמך הם כדלקמן:
...
צומת הגדרות מסמך טיפוסי מכיל את האלמנטים הבאים.
...
צומת הצבעים מכיל ערכי צבע לשימוש בכל המסמך.
...
הצומת FaceNames בקובץ מייצג את מאפייני TypeFace.FaceNames המשמשים במסמך.
...
הצומת StyleSheets מכיל מידע על גיליונות הסגנונות המשמשים במסמך. כל גיליון סגנונות יכול לכלול מידע על מאפייני סגנון, קווים, תבניות מילוי, בלוקי טקסט ואלמנטים אחרים כאלה.

### גיליון מסמכים ###

הצומת DocumentSheet מכיל מידע על מאפייני המסמך ומידע על שם המשתמש, ונראה כך:
...
מכיל מידע על הדפים של מסמך Visio כגון מאפייני עמוד, פריסות, רשתות סרגל, צורות, תמונות ונתונים דומים אחרים.
