...
קבצי AML נשמרים כקבצים בינאריים בדיסק עם תוכן כתוב בקוד בתים. מפרטי פורמט הקובץ של תקן ACPI זמינים ב-[uefi](https://uefi.org/node/735). השפה תוכננה להציע יציבות ותאימות לאחור, הדורשת פחות כתיבה מחדש או בנייה מחדש של ערימת היישומים.
