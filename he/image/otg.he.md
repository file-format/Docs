...
|פריסת עמוד|`סגנון:שם-פריסת עמוד` | מציין פריסת עמוד שמכילה את הגדלים, הגבול והכיוון של דף האב של דף המידע.
