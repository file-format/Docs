...
קבצי IFO עלולים להזיק אם ה-DVD מקבל שריטות. זו הסיבה שקובץ BUP נוצר כגיבוי של קובץ ה-IFO. במקרה שלא ניתן לקרוא את קובץ ה-IFO, קובץ ה-BUP נקרא במקום זאת. קבצים אלה ממוקמים יחד לצד קובץ [VOB](https://docs.fileformat.com/video/vob/) המכיל אינדקס של התוכן בדיסק.
