...
1. `מסמכי כניסת Atom` - זהו מסמך XML המורכב מפריט מידע בודד, המכונה כניסה, עבור הפיד של Atom. יש לו<atom:entry> אלמנט המכיל מספר אלמנטים צאצאים. התוכן של ערך Atom יכול להיות טקסט רגיל, HTML, XHTML או סוג אחר של IANA (Internet Assigned Numbers Authority).
