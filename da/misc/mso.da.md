{
  ...
  "description": "Lær om MSO-filer og API'er, der kan oprette og åbne MSO-filer.",
  "linktitle": "MSO",
  "menu": {
    "docs": {
      "parent": "misc",
      "identifier": "misc-ms-dao"
}
},
  "lastmod": "2022-03-12"
}
...
MSO-filer gemmes i Microsoft Compound Document File Format (MCDF), som også er kendt som Object Linking and Embedding (OLE) eller Component Object Model (COM) struktureret lager sammensat filimplementering binært filformat.
