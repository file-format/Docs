...
"format"
  ...
  "draft": "false",
  "toc": true,
  "description": "Lær om PPTX filformat og API'er, der kan oprette og åbne PPTX filer.",
  "title": "PPTX - PowerPoint-præsentationsfilformat",
  "linktitle": "PPTX",
  "menu": {
    "docs": {
      "parent": "presentation",
      "identifier": "presentation-ppt-dax"
}
},
  "lastmod": "2019-09-10"
}
...
PPTX file format was introduced in 2007 and uses the Open XML standard adapted by Microsoft back in 2000. Før PPTX var det almindelige anvendte filformat PPT, der var rent binært filformat. Den nye filtype har tilføjet fordele ved små filstørrelser, færre ændringer af korruption og velformaterede billeder. Det var i begyndelsen af 2000, da Microsoft besluttede at gå efter ændringen for at imødekomme standarden for **Office Open XML**. I 2007 blev dette nye filformat en del af Office 2007 og videreføres også i de nye versioner af Microsoft Office.

## PPTX filformatspecifikationer

Filer genereret med office Open XML-filformat er en samling af XML-filer sammen med andre filer, der giver links mellem alle de indgående filer. Denne samling er faktisk et komprimeret arkiv, der kan udtrækkes for at se dets indhold. For at gøre det skal du blot omdøbe PPTX-filtypen med zip og udpakke den for at observere dens indhold (se [PPTX file format specifications](https://learn.microsoft.com/en-us/openspecs/office_standards/ms-pptx/efd8bb2d-d888-4e2e-af25-cad476730c9f) af Microsoft).
