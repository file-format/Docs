{
  ...
  "description":"Lær om VSX filformat og API'er, der kan oprette og åbne VSX filer.",
  "linktitle" : "VSX",
  "menu" : {
    "docs" : {
	  "identifier":"visio-vsx-da",
      "parent" : "visio"
}
},
  "lastmod" : "2020-08-03"
...
Files with .vsx extension refer to stencils that consist of drawings and shapes that are used for creating diagrams in Microsoft Visio. VSX files are saved in XML file format and was supported till Visio 2013. Disse er anderledes end det primære [VSDX](/visio/vsdx/)-filformat, der blev introduceret med Microsoft Visio 2013. VSX-filer kan åbnes i enhver teksteditor for at se indholdet. VSX-filer kan konverteres til flere forskellige filformater såsom PDF og HTML.

## VSX-filformat ##

En eksempel-VSX-fil åbnet i XML-editor er som vist nedenfor. En typisk VSX-fil har følgende noder som observeret fra dens XML-repræsentation.

### Dokumentegenskaber ###

Nogle af elementerne i afsnittet Dokumentegenskaber er som følger:
...
En typisk dokumentindstillingsknude indeholder følgende elementer.
...
Farveknuden indeholder farveposter, der skal bruges gennem hele dokumentet.
...
FaceNames-knuden i filen repræsenterer TypeFace.FaceNames-egenskaber, der bruges i dokumentet.
...
StyleSheets-noden indeholder information om de typografiark, der bruges i dokumentet. Hvert typografiark kan have information om typografiegenskaber, linjer, fyldmønstre, tekstblokke og andre sådanne elementer.

### Dokumentark ###

DocumentSheet-noden indeholder oplysninger om dokumentegenskaberne og brugernavnoplysninger og ser ud som følger:
...
Indeholder oplysninger om siderne i et Visio-dokument, såsom sideegenskaber, layout, linealgitter, figurer, billeder og andre lignende data.
