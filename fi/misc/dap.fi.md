{
  ...
  "draft" : "false",
  "toc" : true,
  "title" : "DAP-tiedosto - Lataa Accelerator Plus -lataus käynnissä",
  "description":"Opi DAP-tiedostomuodosta ja sovellusliittymistä, jotka voivat luoda ja avata DAP-tiedostoja.",
  "linktitle" : "DAP",
  "menu" : {
    "docs" : {
      "identifier":"misc-dap-fi",
      "parent" : "misc"
}
},
  "lastmod" : "2022-03-07"
