{
  ...
  "draft" : "false",
  "toc" : true,
  "title" : "VSX - Microsoft Visio Stencil -tiedostomuoto",
  "description":"Opi VSX-tiedostomuodosta ja sovellusliittymistä, jotka voivat luoda ja avata VSX-tiedostoja.",
  "linktitle" : "VSX",
  "menu" : {
    "docs" : {
	  "identifier":"visio-vsx-fi",
      "parent" : "visio"
}
},
  "lastmod" : "2020-08-03"
...
## Mikä on VSX-tiedosto?

Files with .vsx extension refer to stencils that consist of drawings and shapes that are used for creating diagrams in Microsoft Visio. VSX files are saved in XML file format and was supported till Visio 2013. Nämä eroavat ensisijaisesta [VSDX](/visio/vsdx/)-tiedostomuodosta, joka otettiin käyttöön Microsoft Visio 2013:n kanssa. VSX-tiedostot voidaan avata missä tahansa tekstieditorissa sisällön tarkastelua varten. VSX-tiedostoja voidaan muuntaa useisiin eri tiedostomuotoihin, kuten PDF ja HTML.

## VSX-tiedostomuoto ##

Esimerkki VSX-tiedostosta, joka on avattu XML-editorissa, on kuten alla. Tyypillisessä VSX-tiedostossa on seuraavat solmut sen XML-esityksen mukaan.

### Asiakirjan ominaisuudet ###

Jotkut Asiakirjan ominaisuudet -osion elementeistä ovat seuraavat:
...
Tyypillinen asiakirjan asetussolmu sisältää seuraavat elementit.
...
Värisolmu sisältää värimerkintöjä, joita käytetään koko asiakirjan ajan.
...
Tiedoston FaceNames-solmu edustaa asiakirjassa käytettyjä TypeFace.FaceNames-ominaisuuksia.
...
StyleSheets-solmu sisältää tietoja asiakirjassa käytetyistä tyylisivuista. Jokaisella tyylisivulla voi olla tietoa tyyliominaisuuksista, viivoista, täyttökuvioista, tekstilohkoista ja muista vastaavista elementeistä.

### Asiakirjasivu ###

DocumentSheet-solmu sisältää tietoja asiakirjan ominaisuuksista ja käyttäjänimitiedoista, ja se näyttää seuraavalta:
...
Sisältää tietoja Visio-asiakirjan sivuista, kuten sivun ominaisuudet, asettelut, viivainruudukot, muodot, kuvat ja muut vastaavat tiedot.
