{
  ...
  "draft" : "false",
  "toc" : true,
  "title" :"ASC File - Adobe ActionScript File Format",
...
Os arquivos ASC são salvos como arquivos de texto que podem ser abertos e editados com o [Adobe Media Encoder](https://www.adobe.com/products/media-encoder.html). Eles são criados e salvos como arquivos de texto e podem ser abertos com qualquer editor de texto, como Microsoft Notepad, Notepad++ e Apple TextEdit. O arquivo ASC é executado por padrão quando o Flash Media Server é executado e o aplicativo.
