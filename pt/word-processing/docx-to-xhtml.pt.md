...
1. Converta DOCX em XHTML usando Python via .NET - [Guia de conversão de DOCX para XHTML em Python via .NET](https://docs.aspose.com/words/python-net/convert-a-document-to-html-mhtml-or-epub/)
