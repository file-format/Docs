{
  ...
  "draft" : "false",
  "toc" : true,
  "title" :"Converta DOCX em SVG online gratuitamente",
  "description":"Conversão on-line gratuita de DOCX para SVG.",
...
Você pode usar o aplicativo de conversão Aspose.Words GRATUITAMENTE para converter DOCX em SVG clicando no botão a seguir.

[![DOCX para SVG](../docx-to-svg.png?width=120px&height=60px)](https://products.aspose.app/words/conversion/docx-to-svg)


### Etapas para converter DOCX em SVG online - DEMO GRATUITA

Converter DOCX em SVG usando o aplicativo online Aspose.Words é simples e inclui as seguintes etapas.

1. Acesse o aplicativo Aspose.Words para [conversor de DOCX para SVG](https://products.aspose.app/words/conversion/docx-to-svg)
1. Carregue seu arquivo DOCX clicando no botão de upload
1. Quando terminar, pressione o botão Converter. Isso iniciará o processo de conversão do arquivo DOCX para SVG em segundo plano
1. Você será solicitado a baixar o arquivo RTF convertido assim que o processo de conversão de DOCX para SVG for concluído
