{
  ...
  "draft" : "false",
  "toc" : true,
  "title" :"Arquivo DER - Formato de arquivo de certificado DER",
  "description":"Saiba mais sobre o formato de arquivo DER e APIs que podem criar e abrir arquivos DER.",
  "linktitle" : "DER",
  "menu" : {
    "docs" : {
      "identifier":"web-der",
...
Os arquivos DER são armazenados em disco em formato de arquivo binário que não é legível por humanos. Esses arquivos de certificado são carregados e reconhecidos por navegadores da Web padrão para uma navegação segura.

### Como é um certificado codificado em DER?

Um exemplo de um certificado SSL/TLS codificado por DER é mostrado abaixo.
...
## Converter certificado codificado em DER para PEM

Um arquivo de certificado codificado em DER pode ser convertido em PEM usando o comando a seguir.
