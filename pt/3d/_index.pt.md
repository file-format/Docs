{
  "date" : "2020-01-17",
  "keywords" :[ "3D", "arquivo", "formato", "extensão", "GLB" ],
  "author" : {
    "display_name" : "Kashif Iqbal"
},
  "draft" : "false",
  "description" :"Arquivos 3D são uma representação digital de objetos tridimensionais. Aprenda a abrir formatos de arquivo 3D, incluindo GLB, FBX, GLTF, OBJ, PLY, JT, 3DS e outros.",
  "categories" :[ "fundamentos" ],
  "title" :"Saiba mais sobre formatos de arquivo 3D e APIs que podem abrir e criar arquivos 3D",
  "linktitle" : "Formatos de arquivo 3D",
  "menu" : {
    "docs" : {
      "parent" : "3d",
      "weight" : "01"
...
A seguir está uma lista de formatos de arquivo 3D populares que encontram seu uso em quase todos os trabalhos diários relacionados ao 3D.
