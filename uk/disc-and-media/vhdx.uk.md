...
Деталі формату файлу VHDX повністю задокументовані та доступні в Інтернеті як [Специфікації формату файлу VHDX](https://docs.microsoft.com/en-us/openspecs/windows_protocols/ms-vhdx/83e061f8-f6e2-4de1-91bd-5d518a43d477 ) у документації Microsoft. Це розширення формату VHD і містить розширені можливості. Формат файлу VHDX надає додаткові функції, доступні на віртуальному жорсткому диску та на файлових рівнях віртуального жорсткого диска. Він більш оптимізований і дає кращі результати щодо конфігурації обладнання та можливостей зберігання. Файли VHDX можна відкривати
...
* [Специфікації формату файлу VHDX](https://docs.microsoft.com/en-us/openspecs/windows_protocols/ms-vhdx/83e061f8-f6e2-4de1-91bd-5d518a43d477)
