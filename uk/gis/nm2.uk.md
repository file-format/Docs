...
Файли NM2 зберігаються як двійкові файли, а їх внутрішній формат файлів/структура даних недоступні для всіх. Останні версії Навітел зберігають дані у вигляді файлів .nm7. На [веб-сайті] Navitel (https://www.navitel.cz/en/downloads/demo) є кілька файлів карт. [Документація Navitel] (https://www.navitel.cz/en/downloads/documentation) містить повні посібники користувача щодо використання навігаційної системи для різних типів пристроїв і транспортних засобів.
