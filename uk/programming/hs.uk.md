...
Файли Java HS мають формат файлу XML і базуються на запропонованій рекомендації Консорціуму всесвітньої павутини (W3C) Extended Markiup Language [PR-xml-971208](https://www.w3.org/TR/PR-xml-971208). Це означає, що файл Java HS має читабельний формат XML-файлу, який можна відкрити в будь-якій програмі для читання XML.
...
Код можна записати у файлі .hs і скомпільувати за допомогою компілятора Haskell, такого як [GHC](https://haskell.org/ghc). Наступний рядок коду зберігається як `HelloWorld.hs`, як показано в наступному прикладі.
