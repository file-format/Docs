...
* [Швидкий старт: установіть і використовуйте пакет у Visual Studio (тільки для Windows)](https://docs.microsoft.com/en-us/nuget/quickstart/install-and-use-a-package-in-visual- студія)
* [Як створити та опублікувати пакет Nuget](https://docs.microsoft.com/en-us/nuget/quickstart/create-and-publish-a-package-using-visual-studio?tabs=netcore- cli)
