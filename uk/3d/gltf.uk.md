...
Специфікації формату файлу для glTF 2.0 доступні [в Інтернеті](https://github.com/KhronosGroup/glTF/tree/master/specification/2.0) для довідки, і їх слід використовувати для будь-якої реалізації, пов’язаної з читанням/записом для підтримки формат файлу glTF.
...
**Відносні шляхи URI:** або path-noscheme, як визначено в RFC 3986, [розділ 4.2](https://tools.ietf.org/html/rfc3986#section-4.2) — без схеми, повноважень або параметрів. Зарезервовані символи мають мати процентне кодування відповідно до RFC 3986, [розділ 2.2](https://tools.ietf.org/html/rfc3986#section-2.2).
