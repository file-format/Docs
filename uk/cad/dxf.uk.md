...
|Таблиці|Цей розділ містить визначення для кількох різних таблиць, кожна з яких містить ряд різних записів символів. Наприклад, [тип рядка](https://help.autodesk.com/view/ACD/2016/ENU/?guid=GUID-20B4D4B3-1220-426A-847B-5BBE36EC6FDF) таблиця (LTYPE) визначає шаблон тире, крапок, тексту та символів у файлі DXF і спосіб їх масштабування. Ось повний список таблиць у цьому розділі:<ul><li> Таблиця ідентифікаторів програми (APPID).</li><li> Таблиця блокових записів (BLOCK_RECORD).</li><li> Таблиця розмірного стилю (DIMSTYPE).</li><li> Таблиця шарів (LAYER).</li><li> Таблиця типів ліній (LTYPE).</li><li> Таблиця стилів тексту (STYLE).</li><li> Таблиця системи координат користувача (UCS).</li><li> Переглянути (VIEW) таблицю</li><li> Таблиця конфігурації вікна перегляду (VPORT).</li></ul>
