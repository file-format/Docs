...
Файли AML зберігаються як двійкові файли на диск із вмістом, записаним у байт-коді. Специфікації формату файлів стандарту ACPI доступні на [uefi](https://uefi.org/node/735). Мова була розроблена, щоб забезпечити стабільність і зворотну сумісність, вимагаючи менше перезапису або повторного збирання стека програми.
