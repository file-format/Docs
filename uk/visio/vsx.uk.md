{
  "date" : "2019-10-11",
  "keywords" :[ "файл vsx", "формат файлу vsx", "що таке файл vsx", "файл", "приклад vsx", "розширення файлу vsx", "розширення", "формат" ],
  "author" : {
  ...
  "description":"Дізнайтеся про формат файлу VSX та API, які можуть створювати та відкривати файли VSX.",
  "linktitle" : "VSX",
  "menu" : {
    "docs" : {
...
Файли з розширенням .vsx стосуються шаблонів, які складаються з малюнків і фігур, які використовуються для створення діаграм у Microsoft Visio. Файли VSX зберігаються у форматі файлів XML і підтримувалися до Visio 2013. Вони відрізняються від основного формату файлів [VSDX](/uk/visio/vsdx/), який був представлений у Microsoft Visio 2013. Файли VSX можна відкривати в будь-якому текстовому редакторі. щоб переглянути вміст. Файли VSX можна конвертувати в кілька різних форматів файлів, наприклад PDF і HTML.

## Формат файлу VSX ##

Нижче показано приклад файлу VSX, відкритого в редакторі XML. Типовий файл VSX має такі вузли, як видно з його представлення XML.

### Властивості документа ###

Нижче наведено деякі з елементів, які містяться в розділі «Властивості документа».
...
Типовий вузол параметрів документа містить такі елементи.
...
Вузол «Кольори» містить елементи кольорів, які будуть використовуватися в документі.
...
Вузол FaceNames у файлі представляє властивості TypeFace.FaceNames, які використовуються в документі.
...
Вузол StyleSheets містить інформацію про таблиці стилів, які використовуються в документі. Кожна таблиця стилів може містити інформацію про властивості стилю, лінії, шаблони заливки, текстові блоки та інші подібні елементи.

### Аркуш документа ###

Вузол DocumentSheet містить інформацію про властивості документа та інформацію про ім’я користувача та виглядає так:
...
Містить інформацію про сторінки документа Visio, як-от властивості сторінки, макети, сітки лінійки, фігури, зображення та інші подібні дані.
