...
Файл FZPZ — це компонент/частина, яка використовується в розробці електронних схем, створених за допомогою програми для створення прототипів і проектування схем **Fritzing**. Це стислий архів, який містить файл [FZP](/uk/cad/fzp/) і чотири зображення [SVG](/uk/image/svg/), що описують загальну частину Fritzing. Перевага використання цих файлів полягає в тому, що користувачі можуть ділитися своїми файлами FZPZ з кожним із них з точки зору повторного використання. Спільне використання частин FZPZ допомагає в інтеграції частин схеми для швидкого створення більших конструкцій друкованих плат.
