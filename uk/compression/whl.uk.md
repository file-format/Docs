...
Формат файлу WHL — це архів [ZIP](/uk/стиснення/zip/) (.zip), який містить усі інсталяційні файли та метадані, необхідні інсталяторам для інсталяції пакета. Ці файли WHL можна розпакувати за допомогою опції розпакування або стандартних програм для розпакування, таких як WinZIP і WinRAR.
