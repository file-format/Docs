...
Файли, що відповідають стандарту PDF/UA, повинні містити функції, дійсні відповідно до [специфікацій PDF 1.7](http://www.adobe.com/go/pdfreference). Однак слід виключити функції, заборонені саме PDF/UA.
