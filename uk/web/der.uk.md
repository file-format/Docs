...
Файл DER – це файл цифрового сертифіката, який створюється та зберігається у двійковому форматі. Це двійкове кодування для сертифікатів X.509 і закритих ключів. На відміну від файлів PEM ([CRT](https://docs.fileformat.com/web/crt/), [CER](https://docs.fileformat.com/web/cer/)), файли DER не містять простих текстових операторів, зрозумілих людині, наприклад -----BEGIN CERTIFICATE-----. Вони в основному використовуються в контексті Java.
