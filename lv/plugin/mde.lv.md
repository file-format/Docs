{
  ...
  "draft" : "false",
  "toc" : true,
  "title" : "MDE fails — kas ir MDE fails un kā to atvērt?",
  "description":"Uzziniet par MDE failu formātu un API, kas var izveidot un atvērt MDE failus.",
  "linktitle" : "MDE",
  "menu" : {
    "docs" : {
      "parent" : "plugin",
      "identifier":"plugin-en-md-lve"
}
},
  "lastmod" : "2023-12-03"
}
...
.MDE fails ir Access datu bāzes (.mdb vai .accdb) kompilēta versija. Apkopojot Access datu bāzi .MDE failā, to vairs nevar rediģēt, izmantojot standarta Access noformēšanas rīkus. .MDE faila izveides galvenais mērķis ir izplatīt datu bāzes lietojumprogrammu, neatklājot sākotnējo pirmkodu.
