{
  "date" : "2021-02-26",
  "keywords" :[ "SDC", "файл", "расширение", "формат файла", "SDC Calc", "Apache", "OpenOffice", "Электронная таблица" ],
  "author" : {
    "display_name" : "Kashif Iqbal"
},
  "draft" : "false",
  "toc" : true,
  "description":"Узнайте о формате файла SDC и API-интерфейсах, которые могут создавать и открывать файлы SDC.",
  "title" :"SDC — электронная таблица Apache OpenOffice Calc",
  "linktitle" : "SDC",
  "menu" : {
    "docs" : {
      "parent" : "spreadsheet"
...
Файлы SDC сохраняются в проприетарном формате файлов, а их внутренний формат файла неизвестен.
