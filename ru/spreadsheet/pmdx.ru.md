{
  "date" : "2021-02-26",
  "keywords" :[ "pmdx", "файл", "расширение", "формат файла", "Файл SoftMaker PlanMaker", "Электронная таблица" ],
  "author" : {
    "display_name" : "Kashif Iqbal"
},
  "draft" : "false",
  "toc" : true,
  "description":"Узнайте о файле PlanMaker PMDX и API-интерфейсах, которые могут создавать и открывать файлы PMDX.",
  "title" :"PMDX — файл электронной таблицы PlanMaker",
  "linktitle" : "PMDX",
  "menu" : {
    "docs" : {
      "parent" : "spreadsheet"
...
Файлы PMDX хранятся на диске в виде двоичных файлов в проприетарном формате файлов, и его спецификации недоступны для общественности.
