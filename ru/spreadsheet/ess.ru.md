{
  "date" : "2021-02-26",
  "keywords" :[ "ess", "файл", "расширение", "формат файла", "EasySpreadsheet", "электронная таблица" ],
  "author" : {
    "display_name" : "Kashif Iqbal"
},
  "draft" : "false",
  "toc" : true,
  "description":"Узнайте, что такое файл ESS и API, которые могут создавать и открывать файлы ESS.",
  "title" :"ESS — формат файла электронной таблицы EasySpreadsheet",
  "linktitle" : "ESS",
  "menu" : {
    "docs" : {
      "parent" : "spreadsheet"
...
---|---|
|Тип файла| Бинарный |
|Категория файла| Электронная таблица|
|Часть|программного обеспечения EasyOffice|
|Разработчик| Электронная пресса |
|Тип MIME|application/octet-stream|
|Совместимость| Майкрософт Эксель|
|ОС| Майкрософт Windows|
