{
  "date" : "2021-02-26",
  "keywords" :[ "pmd", "файл", "расширение", "формат файла", "Файл SoftMaker PlanMaker", "Электронная таблица" ],
  "author" : {
    "display_name" : "Kashif Iqbal"
},
  "draft" : "false",
  "toc" : true,
  "description":"Узнайте о файле PlanMaker PMD и API-интерфейсах, которые могут создавать и открывать файлы PMD.",
  "title" :"PMD — файл электронной таблицы PlanMaker",
  "linktitle" : "PMD",
  "menu" : {
    "docs" : {
      "parent" : "spreadsheet"
...
Файлы PMD хранятся на диске в виде двоичных файлов в проприетарном формате файлов, и его спецификации недоступны для общественности.
