...
Есть вопросы, связанные с форматами файлов шрифтов? Посетите наше сообщество [форумы](https://forum.fileformat.com/c/font), чтобы воспользоваться знаниями, которыми поделились эксперты по форматам файлов.
