{
  "date" : "2021-08-29",
  "keywords" :[ "adb", "расширение", "файл", "формат файла", "Тип файла базы данных", "Формат файла базы данных", "Alpha Anywhere" ],
  "author" : {
    "display_name" : "Kashif Iqbal"
},
  "draft" : "false",
  "toc" : true,
  "description" :"Узнайте о формате файла ADB и API-интерфейсах, которые могут создавать и открывать файлы ADB.",
  "title" :"ADB — файл базы данных Alpha Five",
  "linktitle" : "ADB",
  "menu" : {
    "docs" : {
      "parent" : "database"
...
Информация о внутреннем формате файлов .adb недоступна для справки разработчика.
