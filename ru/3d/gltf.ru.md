...
Спецификации формата файла для glTF 2.0 доступны [онлайн](https://github.com/KhronosGroup/glTF/tree/main/specification/2.0) для справки, и с ними следует обращаться в любой реализации, связанной с чтением/записью, для поддержки формат файла glTF.
...
**Относительные пути URI:** или схема пути, как определено в RFC 3986, [раздел 4.2](https://datatracker.ietf.org/doc/html/rfc3986#section-4.2) — без схемы, полномочий или параметров. Зарезервированные символы должны быть закодированы в процентах в соответствии с RFC 3986, [раздел 2.2](https://datatracker.ietf.org/doc/html/rfc3986#section-2.2).
