...
Файлы BOK сохраняются как веб-страницы, которые обычно имеют формат, понятный браузеру, например [HTML](/ru/web/html/) или [PHP](/ru/web/php/). Содержимое этих страниц загружается из базы данных ProStores во время выполнения, когда какой-либо покупатель посещает витрину магазина.
