{
  ...
  "draft" : "false",
  "toc" : true,
  "title" :"Файл DER — формат файла сертификата DER",
  "description":"Узнайте о формате файла DER и API-интерфейсах, которые могут создавать и открывать файлы DER.",
  "linktitle" : "DER",
  "menu" : {
    "docs" : {
"идентификатор":"веб-дер",
      "parent" : "web"
}
},
  "lastmod" : "2022-09-12"
...
Файл DER — это файл цифрового сертификата, который создается и хранится в двоичном формате. Это двоичная кодировка сертификатов и закрытых ключей X.509. В отличие от файлов PEM ([CRT](https://docs.fileformat.com/web/crt/), [CER](https://docs.fileformat.com/web/cer/)), файлы DER не не содержать удобочитаемых простых текстовых операторов, таких как -----BEGIN CERTIFICATE-----. Они в основном используются в контексте Java.
