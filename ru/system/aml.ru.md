...
Файлы AML сохраняются как двоичные файлы на диск с содержимым, записанным в байтовом коде. Спецификации формата файла стандарта ACPI доступны на [uefi](https://uefi.org/node/735). Язык был разработан, чтобы обеспечить стабильность и обратную совместимость, требуя меньшего количества переписываний или повторных сборок стека приложений.
