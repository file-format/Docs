...
[Справочное руководство] программиста (https://download.autodesk.com/us/maya/2009help/index.html?url=Glossary_M_.mb_file_format.htm,topicNumber=d0e193865) доступно для разработчиков в разделе документации Maya. MEL основан на командах сценариев оболочки, подобных UINX, для достижения целей. Команды, основанные на сценариях, делают его нерелевантным для обычного и объектно-ориентированного программирования (ООП), что приводит к отсутствию использования структур данных, вызова функций или использования ООП, как в других языках.
