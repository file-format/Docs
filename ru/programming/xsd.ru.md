...
Простой файл XSD со схемой заказа на покупку определяет элементы с помощью тегов, как показано в следующем [пример XSD от Microsoft](https://learn.microsoft.com/en-us/visualstudio/xml-tools/sample-xsd-file-simple-schema?view=vs-2022).
