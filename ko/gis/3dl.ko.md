...
3DL 파일은 iGO 내비게이션 소프트웨어에서 사용하는 iGO Landmark 파일입니다. 관심 지점(POI) 및 랜드마크에 대한 위치 정보를 저장합니다. 이 정보에는 POI 또는 랜드마크에 대한 이름, 위치 및 기타 세부 정보가 포함될 수 있습니다. iGO Landmark 파일 형식은 독점적이며 [iGO 내비게이션 소프트웨어](https://www.nng.com/navigation/)에서만 사용됩니다. 3DL 파일은 지도 데이터 파일과 함께 사용되어 사용자에게 내비게이션 안내를 제공할 수 있습니다.
