...
**QGZ** 파일 형식은 [QGS](https://docs.fileformat.com/gis/qgs/) 파일과 QGD 파일을 포함하는 압축 아카이브입니다. 반면, QGD 파일은 프로젝트의 보조 데이터로 구성된 qgis 프로젝트의 sqlite 데이터베이스입니다. 보조 데이터가 없는 경우 QGD 파일은 비어 있습니다.
