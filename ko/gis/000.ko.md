...
단일 S-57 파일에는 100개 이상의 레이어가 포함될 수 있습니다. S-57 파일의 기능은 객체 클래스(OBJL)의 이름을 기반으로 레이어에 할당됩니다. S-57 파일의 각 피쳐 유형에는 S-57 표준에 정의된 대로 사전 정의된 속성 세트가 있습니다. S-57 object/attribute catalog를 이용하여 더 길고 의미 있는 이름과 연관시킬 수 있는 짧은 이름입니다.
