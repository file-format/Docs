...
AML 파일은 바이트 코드로 작성된 내용과 함께 디스크에 바이너리 파일로 저장됩니다. ACPI 표준의 파일 형식 사양은 [uefi](https://uefi.org/node/735)에서 확인할 수 있습니다. 이 언어는 안정성과 이전 버전과의 호환성을 제공하도록 설계되어 애플리케이션 스택을 다시 작성하거나 다시 빌드할 필요가 없습니다.
