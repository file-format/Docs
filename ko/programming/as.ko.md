{
  ...
  "keywords" :[ "AS", "파일", "확장자", "파일 형식", "", "프로그래밍 가이드", "AS 예제", "Аdоbe Flash", "ActionScript", "Mасrоmediа Flash" ],
  "author" : {
    "display_name" : "Sami Cheema"
},
  "draft" : "false",
  "toc" : true,
  "title" :"AS - ActionScript 파일 형식",
  "description":"AS 파일 형식과 AS 파일을 만들고 열 수 있는 API에 대해 알아보세요.",
  "linktitle" : "AS",
  "menu" : {
    "docs" : {
      "parent" : "programming"
