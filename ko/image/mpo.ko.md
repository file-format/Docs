...
MPO 파일은 두 개의 2D 이미지가 중첩된 후에 존재하는 입체 3D 이미지입니다. 이러한 종류의 이미지는 디지털 카메라로 생성되며 3D 비디오 게임 콘솔 및 3D TV에 널리 사용됩니다. MPO 파일은 두 개 이상의 [JPEG](/ko/image/jpg/) 이미지를 포함하기 때문에 다중 그림 개체라고도 합니다.
