...
DVD가 긁히면 IFO 파일이 손상될 수 있습니다. 이것이 BUP 파일이 IFO 파일의 백업으로 생성되는 이유입니다. IFO 파일을 읽을 수 없는 경우 대신 BUP 파일을 읽습니다. 이러한 파일은 디스크에 있는 내용의 색인이 포함된 [VOB](https://docs.fileformat.com/video/vob/) 파일과 함께 배치됩니다.
