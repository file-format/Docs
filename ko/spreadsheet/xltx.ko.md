{
  "date" : "2019-12-10",
  "keywords" :[ "XLTX", "파일", "확장자", "파일 형식", "Excel Open XML", "스프레드시트" ],
  "author" : {
    "display_name" : "Kashif Iqbal"
},
  "draft" : "false",
  "toc" : true,
  "description" :"XLTX 파일과 이를 생성하고 열 수 있는 API가 무엇인지 알기 위한 파일 형식 가이드",
  "title" :"XLTX 파일이란?",
  "linktitle" : "XLTX",
  "menu" : {
    "docs" : {
...
확장자가 .xltx인 파일은 Office OpenXML 파일 형식 사양을 기반으로 하는 Microsoft Excel 템플릿 파일을 나타냅니다. XLTX 파일에 지정된 것과 동일한 설정을 나타내는 [XLSX](/ko/spreadsheet/xlsx/) 파일을 생성하는 데 사용할 수 있는 표준 템플릿 파일을 만드는 데 사용됩니다.
...
XLTX 파일은 Office OpenXML 파일 형식을 기반으로 하며 XML 및 [ZIP](/ko/compression/zip/)를 사용하여 파일 크기를 줄입니다. 바이너리 XLT 파일 형식을 대체하기 위해 Microsoft Office 2007 릴리스와 함께 만들어졌습니다. XLTX와 마찬가지로 XLT 파일 형식은 Microsoft Excel 2003 및 2007을 사용하여 [XLS](/ko/spreadsheet/xls/) 파일을 만드는 데 사용할 수 있습니다. 이 파일은 파일을 두 번 클릭하여 Microsoft Excel에서 열 수 있습니다. XLTX 파일 형식의 파일 구성은 파일 이름을 ZIP으로 바꾼 다음 디스크에 내용을 추출하여 관찰할 수 있습니다.
