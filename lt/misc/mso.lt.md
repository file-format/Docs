{
  ...
  "draft": "false",
  "toc": true,
  "title": "MSO – „Microsoft Office“ makrokomandos nuorodos failas",
  "description": "Sužinokite apie MSO failą ir API, kurios gali kurti ir atidaryti MSO failus.",
  "linktitle": "MSO",
  "menu": {
    "docs": {
      "parent": "misc",
      "identifier": "misc-ms-lto"
}
},
  "lastmod": "2022-03-12"
}
...
## Microsoft MSO failo formatas

MSO failai išsaugomi Microsoft Compound Document File Format (MCDF), kuris taip pat žinomas kaip objektų susiejimas ir įterpimas (OLE) arba komponentų objektų modelio (COM) struktūrinio saugojimo sudėtinio failo diegimo dvejetainis failo formatas.

### MSO failo formato struktūra
...
* [COM struktūrinė saugykla](https://en.wikipedia.org/wiki/COM_Structured_Storage)
