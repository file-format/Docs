{
  ...
  "draft" : "false",
  "toc" : true,
  "title" : "VSX – „Microsoft Visio“ trafareto failo formatas",
  "description":"Sužinokite apie VSX failo formatą ir API, kurios gali kurti ir atidaryti VSX failus.",
  "linktitle" : "VSX",
  "menu" : {
    "docs" : {
	  "identifier":"visio-vsx-lt",
      "parent" : "visio"
}
},
  "lastmod" : "2020-08-03"
...
Files with .vsx extension refer to stencils that consist of drawings and shapes that are used for creating diagrams in Microsoft Visio. VSX files are saved in XML file format and was supported till Visio 2013. Tai skiriasi nuo pirminio [VSDX](/visio/vsdx/) failo formato, kuris buvo pristatytas naudojant Microsoft Visio 2013. VSX failus galima atidaryti bet kurioje teksto rengyklėje, kad būtų galima peržiūrėti turinį. VSX failus galima konvertuoti į kelis skirtingus failų formatus, tokius kaip PDF ir HTML.

## VSX failo formatas ##

Pavyzdinis VSX failas, atidarytas XML redaktoriuje, yra toks, kaip parodyta toliau. Tipiškas VSX failas turi šiuos mazgus, kaip matyti iš jo XML vaizdavimo.

### Dokumento ypatybės ###

Kai kurie dokumento ypatybių skyriuje esantys elementai yra tokie:
...
Įprastame dokumento nustatymų mazge yra šie elementai.
...
Spalvų mazge yra spalvų įrašai, kurie turi būti naudojami visame dokumente.
...
FaceNames mazgas faile reiškia TypeFace.FaceNames ypatybes, naudojamas dokumente.
...
StyleSheets mazge yra informacijos apie dokumente naudojamus stilių lapus. Kiekviename stiliaus lape gali būti informacijos apie stiliaus ypatybes, linijas, užpildymo modelius, teksto blokus ir kitus panašius elementus.

### Dokumento lapas ###

DocumentSheet mazge yra informacijos apie dokumento ypatybes ir vartotojo vardo informaciją ir jis atrodo taip:
...
Yra informacijos apie Visio dokumento puslapius, pvz., puslapio ypatybes, maketus, liniuotės tinklelius, figūras, vaizdus ir kitus panašius duomenis.
