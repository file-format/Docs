...
"formatu"
  ...
  "draft": "false",
  "toc": true,
  "title": "VRML failo formatas",
  "description": "Sužinokite apie VRML failo formatą ir API, kurios gali atidaryti ir kurti VRML failus.",
  "linktitle": "VRML",
  "menu": {
    "docs": {
      "parent": "3d",
      "identifier": "3d-vrm-ltl"
}
},
  "lastmod": "2019-09-10"
}
...
## Kas yra VRML failas?
Virtualios realybės modeliavimo kalba (VRML) yra failo formatas, skirtas interaktyviems [3D](/3d/) pasaulio objektams per World Wide Web (www) atvaizduoti. Jis naudojamas kuriant sudėtingų scenų trimačius vaizdus, tokius kaip iliustracijos, apibrėžimai ir virtualios realybės pristatymai. Formatą pakeitė [X3D](/3d/x3d/). Daugelis 3D modeliavimo programų gali išsaugoti objektus ir scenas VRML formatu.
