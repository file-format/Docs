{
  ...
  "draft": "false",
  "toc": true,
  "title": "MSO - Microsoft Office Makro İstinad Faylı",
  "description": "MSO faylları yarada və aça bilən MSO faylı və API-lər haqqında məlumat əldə edin.",
  "linktitle": "MSO",
  "menu": {
    "docs": {
      "parent": "misc",
      "identifier": "misc-ms-azo"
}
},
  "lastmod": "2022-03-12"
}
...
## Microsoft MSO fayl formatı

MSO faylları Obyektlərin Bağlanması və Yerləşdirilməsi (OLE) və ya Komponent Obyekt Modeli (COM) strukturlaşdırılmış saxlama mürəkkəb faylının tətbiqi ikili fayl formatı kimi də tanınan Microsoft Mürəkkəb Sənəd Fayl Formatında (MCDF) saxlanılır.

### MSO Fayl Formatının Strukturu
