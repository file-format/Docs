{
  ...
  "description" :"I file di ebook sono file elettronici che possono essere aperti e letti su dispositivi digitali noti come eReader. Le estensioni di file di ebook comuni e i relativi formati di file includono EPUB, FB2 e Mobi.",
  "title" :"Ulteriori informazioni sui formati di file di eBook e sulle API che possono aprire e creare file di eBook",
  "linktitle" : "Formati di file di eBook",
  "menu" : {
    "docs" : {
      "parent" : "ebook",
      "weight" : "01"
...
Di seguito è riportato un elenco di formati di file EBook comuni insieme alle loro estensioni di file.
