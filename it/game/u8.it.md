...
I file U8 sono file di archivio compressi utilizzando il file YAZ0 per ridurre le dimensioni del file. [File system U8](http://wiki.tockdom.com/wiki/U8_(File_Format)) consiste in un elenco di nodi con ciascun nodo composto da 12 byte come mostrato di seguito.
...
* [Formato file Mario Kit Wii U8](http://wiki.tockdom.com/wiki/U8_(File_Format))
