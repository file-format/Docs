{
  "date" : "2019-10-11",
  "keywords" :[ "file vssm", "formato file vssm", "cos'è un file vssm", "file", "esempio vssm", "estensione file vssm", "estensione", "formato" ],
  "author" : {
    "display_name" : "Kashif Iqbal"
},
  "draft" : "false",
  "toc" : true,
  "title" :"VSSM - Formato file abilitato per macro di Microsoft Visio",
  "description":"Scopri il formato di file VSSM e le API che possono creare e aprire file VSSM.",
  "linktitle" : "VSSM",
  "menu" : {
    "docs" : {
...
Il formato di file VSSM è stato introdotto con Microsoft Visio 2013 che si basa sulle specifiche XML di OpenOffice. Alcuni altri tipi di file che comprendono il formato di file di Visio 2013 includono:
