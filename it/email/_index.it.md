{
  ...
  "description" :"I file di posta elettronica sono contenitori digitali che contengono testo, allegati, informazioni sul mittente e sui destinatari. I formati di file di posta elettronica comuni includono EML, MSG, EMLX, TNEF, ICS, OFT, PST e OST.",
  "title" :"Scopri i formati di file e-mail e le API che possono aprire e creare file e-mail",
  "linktitle" : "Formati di file di posta elettronica",
  "menu" : {
    "docs" : {
      "parent" : "email",
      "weight" : "01"
...
Di seguito è riportato un elenco dei tipi di file di posta elettronica più diffusi insieme alle estensioni associate.
