...
Un semplice file XSD con uno schema dell'ordine di acquisto definisce gli elementi utilizzando i tag come mostrato nel seguente [esempio XSD di Microsoft](https://docs.microsoft.com/en-us/visualstudio/xml-tools/sample-xsd-file -schema-semplice?view=vs-2022).
...
- [Esempio di esempio XSD](https://docs.microsoft.com/en-us/visualstudio/xml-tools/sample-xsd-file-simple-schema?view=vs-2022)
