{
  ...
  "draft" : "false",
  "toc" : true,
  "title" :"File DER - Formato file certificato DER",
  "description":"Scopri il formato di file DER e le API che possono creare e aprire file DER.",
  "linktitle" : "DER",
  "menu" : {
    "docs" : {
      "identifier":"web-der",
...
Un file DER è un file di certificato digitale che viene creato e archiviato in formato binario. È una codifica binaria per i certificati X.509 e le chiavi private. A differenza dei file PEM ([CRT](https://docs.fileformat.com/web/crt/), [CER](https://docs.fileformat.com/web/cer/)), i file DER lo fanno non contengono istruzioni di testo in chiaro leggibili come -----BEGIN CERTIFICATE-----. Sono usati principalmente nel contesto di Java.

## Formato file DER - Ulteriori informazioni

I file DER vengono archiviati su disco in un formato di file binario che non è leggibile dall'uomo. Questi file di certificato vengono caricati e riconosciuti dai browser Web standard per una navigazione sicura.

### Come appare un certificato con codifica DER?

Di seguito è mostrato un esempio di certificato SSL/TLS con codifica DER.
...
## Converti il certificato con codifica DER in PEM

Un file di certificato con codifica DER può essere convertito in PEM utilizzando il comando seguente.
...
* [Ottieni un certificato digitale e crea una firma digitale
