...
**File di risorse** – file multimediali o altri file di contenuto a cui si fa riferimento dai metadati del pacchetto/sezione e di solito sono presentazioni di dati di progettazione in vari formati (ZGL, W2D, [JPG](/it/image/jpeg/), [PNG](/it/image/png/), AVI, XML, [TXT](/it/word-processing/txt/), [DOC](/it/word-processing/doc/), ecc.)
