{
  ...
  "description" :"I file compressi sono archivi digitali che archiviano i file riducendo le dimensioni del file. I formati di file compressi più diffusi includono ZIP, 7Z, BZ2, GZ, RAR e TAR.",
  "title" :"Scopri i formati di file di compressione e le API che possono aprire e creare file di archivio",
  "linktitle" : "Formati di file di compressione",
  "menu" : {
    "docs" : {
      "parent" : "compression",
      "weight" : "01"
...
Di seguito è riportato un elenco di formati di file di compressione comuni insieme alle relative estensioni di file.
