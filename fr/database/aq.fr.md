{
  "date" : "2021-09-06",
  "keywords" :[ "aq", "extension", "fichier", "format de fichier", "Type de fichier de base de données", "Format de fichier de base de données", "Fichier de base de données Ancestral Quest" ],
  "author" : {
    "display_name" : "Kashif Iqbal"
},
  "draft" : "false",
  "toc" : true,
  "description" :"En savoir plus sur le format de fichier AQ et les API qui peuvent créer et ouvrir des fichiers AQ.",
  "title" :"AQ - Fichier de base de données de quête ancestrale",
  "linktitle" : "AQ",
  "menu" : {
    "docs" : {
      "parent" : "database"
...
Les fichiers AQ sont enregistrés en tant que fichiers binaires et leur format de fichier interne n'est pas disponible.
