{
  ...
  "draft" : "false",
  "toc" : true,
  "description" :"En savoir plus sur le format de fichier ASK et les API qui peuvent créer et ouvrir des fichiers ASK.",
  "title" :"ASK - Fichier de base de données askSam",
  "linktitle" : "ASK",
  "menu" : {
    "docs" : {
      "parent" : "database"
...
Les fichiers ASK sont enregistrés sur le disque au format de fichier binaire propriétaire dont les détails de format de fichier interne ne sont pas disponibles pour la référence du développeur.
