...
* [Guide d'architecture et de gestion des journaux de transactions](https://docs.microsoft.com/en-us/sql/relational-databases/sql-server-transaction-log-architecture-and-management-guide?view=sql- serveur-ver15)
