{
  "date" : "2019-10-11",
  "keywords" :[ "fichier vst", "format de fichier vst", "qu'est-ce qu'un fichier vst", "fichier", "exemple vst", "extension de fichier vst","extension", "format" ],
  "author" : {
  ...
  "toc" : true,
  "title" :"VST",
  "description":"En savoir plus sur le format de fichier VST et les API qui peuvent créer et ouvrir des fichiers VST.",
  "linktitle" : "VST",
  "menu" : {
    "docs" : {
