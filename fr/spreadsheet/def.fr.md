{
  "date" : "2021-02-26",
  "keywords" :[ "def", "fichier", "extension", "format de fichier", "SmartWare II", "Feuille de calcul" ],
  "author" : {
    "display_name" : "Kashif Iqbal"
},
  "draft" : "false",
  "toc" : true,
  "description":"Découvrez ce qu'est un fichier DEF et les API qui peuvent créer et ouvrir des fichiers DEF.",
  "title" :"DEF - Fichier de données de feuille de calcul SmartWare II",
  "linktitle" : "DEF",
  "menu" : {
    "docs" : {
      "parent" : "spreadsheet"
