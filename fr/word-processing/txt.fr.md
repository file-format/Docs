{
  "date" : "2019-10-11",
  "keywords" :[ "fichier txt", "format de fichier txt", "qu'est-ce qu'un fichier txt", "fichier", "exemple txt", "extension de fichier txt","extension", "format" ],
  "author" : {
    "display_name" : "Kashif Iqbal"
},
  "draft" : "false",
  "toc" : true,
  "title" :"TXT - Fichier de document texte",
  "description":"En savoir plus sur le format de fichier TXT et les API qui peuvent créer et ouvrir des fichiers TXT.",
  "linktitle" : "TXT",
  "menu" : {
    "docs" : {
