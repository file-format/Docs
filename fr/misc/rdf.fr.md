{
  ...
  "description":"En savoir plus sur le fichier cadre de description des ressources RDF et comment l'ouvrir.",
  "linktitle" : "RDF",
  "menu" : {
    "docs" : {
      "identifier": "misc-fr-rdf",
      "parent" : "misc"
    }
  },
  "lastmod" : "2024-01-10"
...
2. **Prédicat :** La propriété ou l'attribut de la ressource.
...
## Les références
* [Cadre de description des ressources](https://en.wikipedia.org/wiki/Resource_Description_Framework)